...
local MAJOR, MINOR = "LibRaces-1.0", tonumber((gsub("r39","r",""))) or 9999;
...
local data = {
	...
	vulpera = {deDE={"Vulpera"},enUS={"Vulpera"},esES={"Vulpera","Vulpera"},esMX={"Vulpera","Vulpera"},frFR={"Vulpérin","Vulpérine"},itIT={"Vulpera","Vulpera"},koKR={"불페라","불페라"},ptBR={"Vulpera","Vulpera"},ptPT={"Vulpera","Vulpera"},ruRU={"Вульпера","Вульпера"},zhCN={"狐人","狐人"},zhTW={"狐狸人","狐狸人"}},
	...
	mechagnome = {deDE={"Mechagnom"},enUS={"Mechagnome"},esES={"Mecagnomo","Mecagnomo"},esMX={"Mecagnomo","Mecagnoma"},frFR={"Mécagnome","Mécagnome"},itIT={"Meccagnomo","Meccagnoma"},koKR={"기계노움","기계노움"},ptBR={"Gnomecânico","Gnomecânica"},ptPT={"Gnomecânico","Gnomecânica"},ruRU={"Механогном","Механогномка"},zhCN={"机械侏儒","机械侏儒"},zhTW={"機械地精","機械地精"}},
