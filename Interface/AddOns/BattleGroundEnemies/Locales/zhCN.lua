...
L["CovenantIcon_Size_Desc"] = "盟约图标的大小 (宽和高)"
L["CovenantIconSettings"] = "盟约图标"
L["CovenantIconSettings_Desc"] = "血条上盟约图标的设置"
...
L["Enemies"] = "敌方"
L["enemies"] = "敌方"
L["EnemiesTargetingAllies_Enabled_Desc"] = "启用后，当一定数量的敌方目标选中队友时，你将收到声音通知"
L["EnemiesTargetingMe_Enabled_Desc"] = "启用后，当一定数量的敌方目标选中你时，你将收到声音通知"
L["enemy"] = "敌方"
L["Enemy"] = "敌方"
...
L["FilterSettings"] = "过滤器设置"
L["Font"] = "字体"
L["Font_Desc"] = "插件所使用的主要字体。"
L["Font_Outline"] = "文字描边"
L["Font_Outline_Desc"] = "文字描边"
L["Fontcolor"] = "文字颜色"
L["Fontcolor_Desc"] = "文本字体的颜色"
...
L["ShowNumbers"] = "显示数字"
L["ShowNumbers_Desc"] = "显示冷却时间，请注意，当你使用 OmniCC 等插件时，此选项可能不起作用"
L["ShowRealmnames"] = "显示服务器"
L["ShowRealmnames_Desc"] = "显示敌方的服务器名"
L["ShowTooltips"] = "显示描述"
L["ShowTooltips_Desc"] = "当你将鼠标移到饰品和光环图标上时显示相关描述"
L["Side"] = "方向"
L["SideAtObject"] = "目标方向"
L["Size"] = "大小"
...
L["TargetAmount"] = "选中数量"
L["TargetAmount_Ally"] = "一旦队友被超过设定数量的敌方选为目标，就会播放声音。"
L["TargetAmount_Me"] = "一旦我被超过设定数量的敌方选为目标，就会播放声音"
L["TargetCallerUpdated"] = "是当前喊火指挥"
L["TargetCalling"] = "喊火指挥"
L["TargetCallingNotificationEnable"] = "启用声音通知"
L["TargetCallingNotificationEnable_Desc"] = "当有新目标时通知你（通过目标骷髅图标检测）"
L["TargetCallingSetMark"] = "用骷髅图标来标记我的目标"
L["TargetCallingSetMark_Desc"] = "当你是团队领袖且没有团队助理时，会自动使用骷髅图标来标记当前目标。如果你不是团队领袖而是助理，也会标记你的当前目标。"
...
L["TargetCallingSoundSound"] = "通知声音"
