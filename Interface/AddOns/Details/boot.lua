...
--> global name declaration
		...
		_detalhes.build_counter = 217
		_detalhes.alpha_build_counter = 217 --if this is higher than the regular counter, use it instead
		_detalhes.game_version = "v1.13.7"
		_detalhes.userversion = "v1.13.7." .. _detalhes.build_counter
