...
BuffMaster_04e2af0c3c5264627fd6ef8473e55adc = 30
...
local function BuffMaster_c31924e73a2e21b7c72a19121ea9200d(button, isPet)
    ...
    if (isPet) then
        ...
        GameTooltip:SetUnitAura("party" .. button:GetParent():GetID(),
                                button:GetID(), bType)
    end
end
local function CreatePartyBuffFrmae(unit, parent)
    ...
    frame:SetID(parent:GetID())
    frame:SetHeight(20)
    frame:SetWidth(150)
    frame:SetPoint("TOPLEFT", parent, "TOPLEFT", 47, -41)
    local lastbutton, bname
    for i = 1, MAX_PARTY_TOOLTIP_BUFFS, 1 do
        bname = fname .. "Buff" .. i
        local button = CreateFrame("Frame", bname, frame,
        ...
        if (unit == "pet") then
            button:SetScript("OnEnter", function()
                BuffMaster_c31924e73a2e21b7c72a19121ea9200d(button, 1)
            end)
        else
            button:SetScript("OnEnter", function()
                BuffMaster_c31924e73a2e21b7c72a19121ea9200d(button)
            end)
        end
        lastbutton = button
    end
...
local function CreateTargetDebuff()
    ...
    for i = 5, BuffMaster_e2834e0a7893ec83a826b8dd5c13163d, 1 do
        ...
        if _G[name] then
            button = CreateFrame("Frame", name, TargetofTargetFrame,
                                 "TargetofTargetDebuffFrameTemplate")
            button:SetID(i)
            if (i == 5) then
                button:SetPoint("TOPLEFT", TargetofTargetFrameDebuff1,
                                "BOTTOMLEFT", 0, -1)
            else
...
local function BuffMaster_17107aa3a9294eaac1b70bf7d4e141f8(
    BuffMaster_5e57c2750895232501d674704d8ef219)
    local BuffMaster_a22192947cbcf5f27a4eaf500379d03d,
          BuffMaster_9a992620b1ab448fb232dcdc06401e99
    BuffMaster_a22192947cbcf5f27a4eaf500379d03d =
        ceil(BuffMaster_5e57c2750895232501d674704d8ef219 / 60)
    BuffMaster_9a992620b1ab448fb232dcdc06401e99 =
        mod(BuffMaster_5e57c2750895232501d674704d8ef219, 60)
    if BuffMaster_a22192947cbcf5f27a4eaf500379d03d >= 2 then
        return ("%d m"):format(BuffMaster_a22192947cbcf5f27a4eaf500379d03d)
    else
        return ("%d s"):format(BuffMaster_9a992620b1ab448fb232dcdc06401e99)
    end
end
local function BuffMaster_5862405e86a346b90bd821f493df30ca(
    BuffMaster_5e57c2750895232501d674704d8ef219)
    local BuffMaster_a22192947cbcf5f27a4eaf500379d03d,
          BuffMaster_9a992620b1ab448fb232dcdc06401e99
    BuffMaster_a22192947cbcf5f27a4eaf500379d03d =
        floor(BuffMaster_5e57c2750895232501d674704d8ef219 / 60)
    BuffMaster_9a992620b1ab448fb232dcdc06401e99 =
        mod(BuffMaster_5e57c2750895232501d674704d8ef219, 60)
    if BuffMaster_a22192947cbcf5f27a4eaf500379d03d >= 1 then
        return ("%d:%02d"):format(BuffMaster_a22192947cbcf5f27a4eaf500379d03d,
                                  BuffMaster_9a992620b1ab448fb232dcdc06401e99)
    else
        return ("%d s"):format(BuffMaster_9a992620b1ab448fb232dcdc06401e99)
    end
...
BuffMaster_Eventer:Init{
    name = "BuffMaster",
    func = function()
        for BuffMaster_63a9ce6f1eeac72ef41293b7d0303335,
            BuffMaster_8d0644c92128c1ff68223fd74ba63b56 in
            pairs(BuffMaster_7f5efba01c95612f5e29b811158e740f) do
            CreatePartyBuffFrmae(BuffMaster_63a9ce6f1eeac72ef41293b7d0303335,
                                 BuffMaster_8d0644c92128c1ff68223fd74ba63b56)
            CreatePartyDebuff(BuffMaster_63a9ce6f1eeac72ef41293b7d0303335,
                              BuffMaster_8d0644c92128c1ff68223fd74ba63b56)
        end
        for BuffMaster_e914904fab9d05d3f54d52bfc31a0f3f,
            BuffMaster_8d0644c92128c1ff68223fd74ba63b56 in
            ipairs(BuffMaster_e2102cef7e78b885d7075bb10028e39f) do
            CreatePetDebuff(BuffMaster_8d0644c92128c1ff68223fd74ba63b56)
        end
        if _G.TargetofTargetFrameDebuff3 and _G.TargetofTargetFrameDebuff2 then
            TargetofTargetFrameDebuff3:ClearAllPoints()
            TargetofTargetFrameDebuff3:SetPoint("LEFT",
                                                TargetofTargetFrameDebuff2,
                                                "RIGHT", 1, 0)
        end
        CreateTargetDebuff()
        BuffMaster_OnLoad()
    ...
    if (toggle == 1) then
        ...
        if (not BuffMaster_cc3105e145f6df0060a4d4779ae40c0e) then
            hooksecurefunc("AuraButton_UpdateDuration",
                           BuffMaster_1a92d5dc80e48e09f7d29aaaab46094b)
            hooksecurefunc("AuraButton_Update",
                           BuffMaster_81244f624fe0b105f47a78834d1c8775)
            hooksecurefunc("TempEnchantButton_OnUpdate",
                           BuffMaster_cfd39af31951c0ec4dc60d7b4dd5feb4)
...
function BuffMaster_ToggleShowParty(toggle)
    if (toggle == 1) then
        BuffMaster_Eventer:RegisterEvent("GROUP_ROSTER_UPDATE",
                                         BufferMasterPartyBuffFrame_OnEvent)
        BuffMaster_Eventer:RegisterEvent("PARTY_MEMBER_ENABLE",
                                         BufferMasterPartyBuffFrame_OnEvent)
        BuffMaster_Eventer:RegisterEvent("PARTY_MEMBER_DISABLE",
                                         BufferMasterPartyBuffFrame_OnEvent)
        ...
        for i = 1, 4, 1 do
            ...
            parent:RegisterAnchorFrame(button, 9, "TOPLEFT", "TOPRIGHT", 23, 6,
                                       0)
            if (not BuffMaster_133104d326d458eda34112321a734dac) then
                parent:HookScript("OnEnter",
        ...
        BuffMaster_Eventer:UnregisterEvent("GROUP_ROSTER_UPDATE")
        BuffMaster_Eventer:UnregisterEvent("PARTY_MEMBER_ENABLE")
        BuffMaster_Eventer:UnregisterEvent("PARTY_MEMBER_DISABLE")
...
function BuffMaster_OnLoad() end
function BufferMasterPartyBuffFrame_OnEvent(
    BuffMaster_d0708241b607c9a9dd1953c812fadfb7,
    BuffMaster_fd724fd3c5e25aaf3b4226e1dae5257c)
    local BuffMaster_8983c60d66c8593ec7165ea9dbedb584
    if (BuffMaster_d0708241b607c9a9dd1953c812fadfb7 == "GROUP_ROSTER_UPDATE") then
        BuffMaster_8983c60d66c8593ec7165ea9dbedb584 = UnitName("party1")
        if (BuffMaster_8983c60d66c8593ec7165ea9dbedb584 and
            BuffMaster_Eventer.name1 ~=
            BuffMaster_8983c60d66c8593ec7165ea9dbedb584) then
            BuffMaster_Eventer.name1 =
                BuffMaster_8983c60d66c8593ec7165ea9dbedb584
            BuffMaster_7c8ac5ae1087c3f9729423abcf45b74a("party1",
                                                        "BuffMasterparty1BuffFrame")
        end
        BuffMaster_8983c60d66c8593ec7165ea9dbedb584 = UnitName("party2")
        if (BuffMaster_8983c60d66c8593ec7165ea9dbedb584 and
            BuffMaster_Eventer.name2 ~=
            BuffMaster_8983c60d66c8593ec7165ea9dbedb584) then
            BuffMaster_Eventer.name2 =
                BuffMaster_8983c60d66c8593ec7165ea9dbedb584
            BuffMaster_7c8ac5ae1087c3f9729423abcf45b74a("party2",
                                                        "BuffMasterparty1BuffFrame")
        end
        BuffMaster_8983c60d66c8593ec7165ea9dbedb584 = UnitName("party3")
        if (BuffMaster_8983c60d66c8593ec7165ea9dbedb584 and
            BuffMaster_Eventer.name3 ~=
            BuffMaster_8983c60d66c8593ec7165ea9dbedb584) then
            BuffMaster_Eventer.name3 =
                BuffMaster_8983c60d66c8593ec7165ea9dbedb584
            BuffMaster_7c8ac5ae1087c3f9729423abcf45b74a("party3",
                                                        "BuffMasterparty1BuffFrame")
        end
        BuffMaster_8983c60d66c8593ec7165ea9dbedb584 = UnitName("party4")
        if (BuffMaster_8983c60d66c8593ec7165ea9dbedb584 and
            BuffMaster_Eventer.name4 ~=
            BuffMaster_8983c60d66c8593ec7165ea9dbedb584) then
            BuffMaster_Eventer.name4 =
                BuffMaster_8983c60d66c8593ec7165ea9dbedb584
            BuffMaster_7c8ac5ae1087c3f9729423abcf45b74a("party4",
                                                        "BuffMasterparty1BuffFrame")
        end
    elseif (BuffMaster_d0708241b607c9a9dd1953c812fadfb7 == "UNIT_AURA") then
        if (BuffMaster_fd724fd3c5e25aaf3b4226e1dae5257c == "pet") then
            BuffMaster_7c8ac5ae1087c3f9729423abcf45b74a("pet",
                                                        "BuffMasterpetBuffFrame")
...
function BuffMaster_7c8ac5ae1087c3f9729423abcf45b74a(
    BuffMaster_fd724fd3c5e25aaf3b4226e1dae5257c,
    BuffMaster_411b8aa6d5954c6020f0b9c9e80e847a)
    local name, icon
    if BuffMaster_a31fc3bbeb1eca3cba8bda3cafca137b then
        bType = "PLAYER"
    else
    ...
    for i = 1, MAX_PARTY_TOOLTIP_BUFFS do
        name, icon = UnitAura(BuffMaster_fd724fd3c5e25aaf3b4226e1dae5257c, i,
                              bType)
        if name then
            _G[BuffMaster_411b8aa6d5954c6020f0b9c9e80e847a .. "Buff" .. i ..
                "Icon"]:SetTexture(icon)
            _G[BuffMaster_411b8aa6d5954c6020f0b9c9e80e847a .. "Buff" .. i]:Show()
        else
...
function BuffMaster_1a92d5dc80e48e09f7d29aaaab46094b(buffButton, timeLeft)
    ...
    if (timeLeft) then
        if BuffMaster_da98fb50047ebbc8f6a22e222b93ef46 then
            ...
            duration:SetText(BuffMaster_17107aa3a9294eaac1b70bf7d4e141f8(
                                 timeLeft))
        end
        ...
        elseif (timeLeft < BUFF_DURATION_WARNING_TIME) then
            duration:SetVertexColor(HIGHLIGHT_FONT_COLOR.r,
...
function BuffMaster_81244f624fe0b105f47a78834d1c8775(buttonName, index, filter)
    ...
    local name, _, _, _, _, expirationTime = UnitAura(unit, index, filter)
