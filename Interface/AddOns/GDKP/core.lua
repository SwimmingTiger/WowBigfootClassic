local T =
    LibStub("AceAddon-3.0"):NewAddon("GDKP", "AceEvent-3.0", "AceHook-3.0")
...
if GetLocale() == 'zhCN' then
    ...
    GDKP_TEXT_NEWINCOME_DESC =
        " 以下为该次活动自动记录的物品列表，请根据需要修改物品价值。修改后的物品将自动转移到管理记录列表中。"
    GDKP_TEXT_NEWINCOM_NEWITEM_DESC =
        "手动添加物品或额外收入请点击“添加收入”进行操作"
    GDKP_TEXT_NEWIEXPENSE_NEWITEM_DESC =
        "手动添加支出项目请点击“添加支出”进行操作"
    GDKP_LABEL_EDIT = "修改"
    GDKP_LABEL_DEL = "刪除"
...
elseif GetLocale() == 'zhTW' then
    ...
    GDKP_TEXT_EXPENSE_DESC = "支出描述"
    GDKP_TEXT_NEWINCOME_DESC =
        " 以下為該次活動自動記錄的物品列表，請根據需要修改物品價值。修改後的物品將自動轉移到管理記錄列表中。"
    GDKP_TEXT_NEWINCOM_NEWITEM_DESC =
        "手動添加物品或額外收入請點擊“添加收入”進行操作"
    GDKP_TEXT_NEWIEXPENSE_NEWITEM_DESC =
        "手動添加支出項目請點擊“添加支出”進行操作"
    GDKP_LABEL_EDIT = "修改"
    GDKP_LABEL_DEL = "刪除"
    ...
    GDKP_TEXT_INCOME_DESC =
        "Income description (shift+Click on item link to autofill)"
    ...
    GDKP_TEXT_NEWINCOM_NEWITEM_DESC =
        "To extra Items or income, please click on \"New Income\" button"
...
local function GDKP_9336171702a6bc3810b21190594210d9(
    GDKP_acd18e5e4cc047ed8d218397986e9dc2, GDKP_a8858383576d7634cceceaf04a2ddb29)
    local GDKP_8e0e84596da5717799a875d1aeeb63bc =
        function(s, e, ...) if (s and e) then return ... end end
    return GDKP_8e0e84596da5717799a875d1aeeb63bc(
               string.find(GDKP_acd18e5e4cc047ed8d218397986e9dc2,
...
local function GDKP_93dd10c14ba6d9968dde1fcd8b5345c8(arg1)
    ...
    if (not GDKP_e498578b78aa0db9c45f30f87d63debc) then
        GDKP_9c987de176f2b454baede402cee36bfa, GDKP_e498578b78aa0db9c45f30f87d63debc, GDKP_3f50417fb16be9b1078eb68d24fa9c26 =
            GDKP_9336171702a6bc3810b21190594210d9(arg1, GDKP_LOOT_ITEM_MULTIPLE)
    end
    if (not GDKP_e498578b78aa0db9c45f30f87d63debc) then
    ...
    if (not GDKP_e498578b78aa0db9c45f30f87d63debc) then
        GDKP_e498578b78aa0db9c45f30f87d63debc, GDKP_3f50417fb16be9b1078eb68d24fa9c26 =
            GDKP_9336171702a6bc3810b21190594210d9(arg1,
                                                  GDKP_LOOT_ITEM_SELF_MULTIPLE)
    end
    if (not GDKP_e498578b78aa0db9c45f30f87d63debc) then
        GDKP_e498578b78aa0db9c45f30f87d63debc =
            GDKP_9336171702a6bc3810b21190594210d9(arg1, GDKP_LOOT_ITEM_SELF)
    end
    if (not GDKP_e498578b78aa0db9c45f30f87d63debc) then
        GDKP_e498578b78aa0db9c45f30f87d63debc =
            GDKP_9336171702a6bc3810b21190594210d9(arg1,
                                                  GDKP_LOOT_ITEM_PUSHED_SELF)
    end
    if (not GDKP_e498578b78aa0db9c45f30f87d63debc) then
        GDKP_e498578b78aa0db9c45f30f87d63debc, GDKP_3f50417fb16be9b1078eb68d24fa9c26 =
            GDKP_9336171702a6bc3810b21190594210d9(arg1,
                                                  GDKP_LOOT_ITEM_PUSHED_SELF_MULTIPLE)
    end
    if (not GDKP_9c987de176f2b454baede402cee36bfa or
        GDKP_9c987de176f2b454baede402cee36bfa == YOU) then
        GDKP_9c987de176f2b454baede402cee36bfa = UnitName("player")
    end
    if (not GDKP_e498578b78aa0db9c45f30f87d63debc) then return end
    GDKP_3f50417fb16be9b1078eb68d24fa9c26 =
        GDKP_3f50417fb16be9b1078eb68d24fa9c26 or 1
    return GDKP_9c987de176f2b454baede402cee36bfa,
           GDKP_e498578b78aa0db9c45f30f87d63debc,
           (GDKP_3f50417fb16be9b1078eb68d24fa9c26 == 1 and
               GDKP_e498578b78aa0db9c45f30f87d63debc) or
               GDKP_e498578b78aa0db9c45f30f87d63debc .. "x" ..
               GDKP_3f50417fb16be9b1078eb68d24fa9c26
end
local function GDKP_17f19a911781c205920d1760e7dfc736(
    GDKP_acd18e5e4cc047ed8d218397986e9dc2)
    GDKP_acd18e5e4cc047ed8d218397986e9dc2 =
        string.gsub(GDKP_acd18e5e4cc047ed8d218397986e9dc2, "%(", "%%(")
    GDKP_acd18e5e4cc047ed8d218397986e9dc2 =
        string.gsub(GDKP_acd18e5e4cc047ed8d218397986e9dc2, "%)", "%%)")
    GDKP_acd18e5e4cc047ed8d218397986e9dc2 =
        string.gsub(GDKP_acd18e5e4cc047ed8d218397986e9dc2, "%%s", "(.-)")
    GDKP_acd18e5e4cc047ed8d218397986e9dc2 =
        string.gsub(GDKP_acd18e5e4cc047ed8d218397986e9dc2, "%%d", "(%%d+)")
...
local function GDKP_9f069b4b2abd8b59dd593eb05c0eb053()
    ...
    GDKP_LOOT_ITEM_MULTIPLE = GDKP_17f19a911781c205920d1760e7dfc736(
                                  LOOT_ITEM_MULTIPLE)
    GDKP_LOOT_ITEM_SELF = GDKP_17f19a911781c205920d1760e7dfc736(LOOT_ITEM_SELF)
    GDKP_LOOT_ITEM_SELF_MULTIPLE = GDKP_17f19a911781c205920d1760e7dfc736(
                                       LOOT_ITEM_SELF_MULTIPLE)
    GDKP_LOOT_ITEM_PUSHED_SELF = GDKP_17f19a911781c205920d1760e7dfc736(
                                     LOOT_ITEM_PUSHED_SELF)
    GDKP_LOOT_ITEM_PUSHED_SELF_MULTIPLE =
        GDKP_17f19a911781c205920d1760e7dfc736(LOOT_ITEM_PUSHED_SELF_MULTIPLE)
    GDKP_RAID_MEMBER_ADDED = GDKP_17f19a911781c205920d1760e7dfc736(
                                 ERR_RAID_MEMBER_ADDED_S)
    GDKP_RAID_MEMBER_REMOVED = GDKP_17f19a911781c205920d1760e7dfc736(
                                   ERR_RAID_MEMBER_REMOVED_S)
    GDKP_RAID_YOU_JOINED = GDKP_17f19a911781c205920d1760e7dfc736(
                               ERR_RAID_YOU_JOINED)
    GDKP_RAID_YOU_LEFT =
        GDKP_17f19a911781c205920d1760e7dfc736(ERR_RAID_YOU_LEFT)
end
local function GDKP_d46ced55976240072f56c23890a2fc3b(itemLink)
    local pattern =
        "|c%x+|Hitem:(%d+):%-?%d+:%-?%d+:%-?%d+:%-?%d+:%-?%d+:%-?%d+:%-?%d+:%-?%d+|h%[(.+)%]|h|r"
...
function EM:FireEvent(event)
    if not self.eventTable[event] then return end
...
function EM:OnInitialize() self.eventTable = {} end
...
local function GDKP_625814a4f8ec0bfbf26894c87ca2cd9a(rType)
    ...
    if type(rType) == "number" then
        assert(rType > 0 and rType <= #RM.recordTypes,
...
function RM:GetRecordList(rType)
    ...
    elseif rType == "Income" then
        local template1, template2 = T.Templates.NormalItemRecord,
                                     T.Templates.SpecialIncomeRecord
        for i = 1, #self.records do
            if AceOO.inherits(self.records[i], template1) or
                AceOO.inherits(self.records[i], template2) then
...
function RM:DeleteRecord(record)
    ...
    assert(index > 0 and index <= #self.records,
           "<RM>: Invalid index for delete")
...
function RM:FindRecord(record)
    for i = 1, #self.records do
        if self.records[i] == record then return i end
    end
...
function RM:OnInitialize() T.debug(3, "<RM>: Initializing...") end
function RM:OnEnable()
    T.debug(3, "<RM>: Enabling...")
    RM:LoadRecords()
end
function RM:OnDisable() end
GM = T:NewModule("GoldManager")
if not GM then return end
UM = T:NewModule("UIManager")
if not UM then return end
function GM:SetUserSetted(flag) self.account:SetUserSetted(flag) end
function GM:IsUserSetted() return self.account:IsUserSetted() end
function GM:SetNumMembers(number)
    if number and number > 0 then self.account:SetNumMembers(number) end
end
function GM:GetNumMembers() return self.account:GetNumMembers() or 1 end
function GM:GetAverage() return self.account:GetAverage() end
function GM:GetIncome() return self.account:GetIncome() end
function GM:GetExpense() return self.account:GetExpense() end
function GM:GetTankSubsidy() return self.account:GetExpense("TANK_SUBSIDY") end
function GM:GetHealerSubsidy() return self.account:GetExpense("HEALER_SUBSIDY") end
function GM:GetGeneralExpense() return
    self.account:GetExpense("GENERAL_EXPENSE") end
function GM:GetProfit() return self.account:GetProfit() end
...
function GM:OnInitialize() T.debug(3, "<GM>: Initializing...") end
function GM:Reset()
    self:UpdateRecords()
...
local function GDKP_e02c71e1241bcc3c74ba4f8152ea6a49(frame)
    ...
    frame.closeButton.OnClick = function(bn) bn:GetParent():Hide() end
end
local function GDKP_9693cf7251ebd2f6eb6bc572b2e5a188()
    ...
    frame.newExpenseButton.OnClick = function(button)
        ...
        frame.editable:SetCommitCallback(function() RM:AddRecord(record) end)
    ...
    frame.resetButton.OnClick = function() SafePopup_Show("GDKP_RESET_DATA") end
    ...
    frame.saveButton.OnClick = function() BigFoot_RequestReloadUI() end
    ...
    frame.reportButton.OnClick = function() T:Report() end
    ...
    frame:SetScript("OnShow", function() EM:FireEvent("UPDATE_GOLD") end)
    frame.editable = T.Templates.RecordExpenseEditable:new(
                         "RecordExpenseEditableUI")
    frame.memberPlusButton:SetScript("OnClick", function()
        GM:SetUserSetted(true)
        UM:SetNumMember(GM:GetNumMembers() + 1)
    end)
    frame.memberMinusButton:SetScript("OnClick", function()
        GM:SetUserSetted(true)
        if GM:GetNumMembers() > 1 then
            UM:SetNumMember(GM:GetNumMembers() - 1)
        end
    end)
    frame.memberEditBox:SetScript("OnTextChanged", function(box, userInput)
        if isUserInput then GM:SetUserSetted(true) end
...
local function GDKP_b46a9a8d0d453ba05fdc42241de4dbf1()
    ...
    UM.newIncomePanel:SetShowCallback(function(panel)
        panel:SetRecordList(RM:GetRecordList("NewIncome"))
        panel:UpdatePanel()
    end)
    UM.newIncomePanel:SetDeleteCallback(function(cell)
        local dialog = SafePopup_Show("GDKP_DELETE_RECORD",
                                      cell:GetRecord():GetDesc())
        dialog.cell = cell
        dialog.panel = UM.newIncomePanel
    end)
    UM.newIncomePanel:SetNewCallback(function(cell)
        RM:AddRecord(cell:GetRecord())
        UM.newIncomePanel:AddRecord(cell:GetRecord())
    end)
    UM.newIncomePanel:SetEditCallback(function(cell)
        EM:FireEvent("UPDATE_GOLD")
    end)
    return parent
end
local function GDKP_ecdc44ef55e944effa19684f3c4c942a()
    ...
    UM.incomePanel:SetShowCallback(function(panel)
        T.debug(3, "<UM>:Showing Incoming Tab")
        panel:SetRecordList(RM:GetRecordList("Income"))
        panel:UpdatePanel()
    end)
    UM.incomePanel:SetDeleteCallback(function(cell)
        local dialog = SafePopup_Show("GDKP_DELETE_RECORD",
                                      cell:GetRecord():GetDesc())
        dialog.cell = cell
        dialog.panel = UM.incomePanel
    end)
    UM.incomePanel:SetNewCallback(function(cell)
        RM:AddRecord(cell:GetRecord())
        UM.incomePanel:AddRecord(cell:GetRecord())
    end)
    UM.incomePanel:SetEditCallback(
        function(cell) EM:FireEvent("UPDATE_GOLD") end)
    return parent
end
local function GDKP_a46102b8fc80c5b62666117722e42454()
    ...
    UM.expensePanel:SetShowCallback(function(panel)
        T.debug(3, "<UM>:Showing Expense Tab")
        panel:SetRecordList(RM:GetRecordList("Expense"))
        panel:UpdatePanel()
    end)
    UM.expensePanel:SetDeleteCallback(function(cell)
        local dialog = SafePopup_Show("GDKP_DELETE_RECORD",
                                      cell:GetRecord():GetDesc())
        dialog.cell = cell
        dialog.panel = UM.expensePanel
    end)
    UM.expensePanel:SetNewCallback(function(cell)
        RM:AddRecord(cell:GetRecord())
        UM.expensePanel:AddRecord(cell:GetRecord())
    end)
    UM.expensePanel:SetEditCallback(function(cell)
        EM:FireEvent("UPDATE_GOLD")
    end)
end
local function GDKP_1d708ad1bb49e15326da5aca9c924459()
    ...
    UM.logPanel:SetShowCallback(function(panel)
        T.debug(3, "<UM>:Showing Log Tab")
        panel:SetRecordList(RM:GetRecordList())
        panel:UpdatePanel()
    end)
    UM.logPanel:SetDeleteCallback(function(cell)
        local dialog = SafePopup_Show("GDKP_DELETE_RECORD",
                                      cell:GetRecord():GetDesc())
        dialog.cell = cell
        dialog.panel = UM.logPanel
    end)
    UM.logPanel:SetNewCallback(function(cell)
        RM:AddRecord(cell:GetRecord())
...
local function GDKP_41b8bcac30854521200367706b48d656(self, file)
    ...
    for i = 1, #texturePieces do
        ...
        local texture = self:CreateTexture(self:GetName() .. piece.name,
                                           "BACKGROUND")
        ...
        if point1 then
            if point1[2] == "Parent" then
                ...
                texture:SetPoint(point1[1], _G[self:GetName() .. point1[2]],
                                 point1[3])
            end
        end
        if point2 then
            if point2[2] == "Parent" then
                ...
                texture:SetPoint(point2[1], _G[self:GetName() .. point2[2]],
                                 point2[3])
            end
        end
...
function GDKP_Frame_OnLoad(self)
    GDKP_41b8bcac30854521200367706b48d656(self,
                                          [[Interface\AddOns\GDKP\img\frameborder]])
end
function GDKP_InnerFrame_OnLoad(self)
    GDKP_41b8bcac30854521200367706b48d656(self,
                                          [[Interface\AddOns\GDKP\img\innerframeborder]])
end
...
function ShowGDKPPanel() UM.mainFrame:Show() end
...
function UM:SetNumMember(num) self.mainFrame.memberEditBox:SetText(num) end
...
function UM:UpdateGoldDisplay()
    ...
    if GM:GetNumMembers() and GM:GetNumMembers() > 0 then
        self.mainFrame.aveProfitText:SetText(
            ("%d金"):format(max(GM:GetProfit() / GM:GetNumMembers(), 0)))
    else
    ...
    self.mainFrame.healerSubsideText:SetText(
        ("%d金"):format(GM:GetHealerSubsidy()))
end
...
function T:Report()
    ...
    local str = "*** [GDKP] 团队通报 ***\n"
    str = str .. RM:GetReport(function(report)
    ...
    for line in str:gmatch("[^\n]+") do SendChatMessage(line, "RAID") end
end
...
function T:CHAT_MSG_LOOT(...)
    local _, message = ...
    local player, itemLink, itemString =
        GDKP_93dd10c14ba6d9968dde1fcd8b5345c8(message)
    ...
    if (name and quality) then
        if GDKP_332126e2e82fafa6f5d15f912aba69c6(link) then return end
...
local GDKPLauncher = LDB:NewDataObject("GDKP", {
    type = "launcher",
...
if not GDKPLDBIcon then return end
hooksecurefunc(GDKP, "OnInitialize", function(self)
    self.db.profile.minimap = self.db.profile.minimap or
                                  {hide = false, minimapPos = 240, radius = 80}
...
function TM:Run()
    ...
    print("|cff3344AA********************************************|r ")
    if failed > 0 then
        print("|cff3344AA<TM>:|r Total |cffEE0022" .. success + failed ..
                  "|r test cases ran, |cffEE0022" .. success .. "/" ..
                  (success + failed) .. "|r Succeed.")
    else
        print("|cff3344AA<TM>:|r Total |cff00DD22" .. success + failed ..
                  "|r test cases ran, |cff00DD22" .. success .. "/" ..
                  (success + failed) .. "|r Succeed.")
    end
    for inx, val in pairs(messages) do
        print("|cffEE0022<TM>: |r" .. inx .. " Failed at: |cffCC0022" .. val ..
                  "|r")
    end
end
function TM:OnEnable() end
function TM:OnDisable() end
