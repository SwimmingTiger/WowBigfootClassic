...
local ChannelFilter_76d6f12ba3810515a6368ac18850ddac,
      ChannelFilter_f6fa3c07b3d3d1066da321072c9f8b53
...
if (GetLocale() == "zhCN") then
    CHANNEL_FILTER_MSG_ALREADY_EXIST =
        "|cff00adef[聊天优化]|r 关键字\"|cffff0000%s|r\"已经存在于文字列表中。"
    CHANNEL_FILTER_MSG_ADDED =
        "|cff00adef[聊天优化]|r 关键字\"|cffff0000%s|r\"已经被加入至文字列表中。"
    CHANNEL_FILTER_MSG_REMOVED =
        "|cff00adef[聊天优化]|r 关键字\"|cffff0000%s|r\"已经从文字列表中删除。"
    CHANNEL_FILTER_MSG_KEY_NOT_FOUND =
        "|cff00adef[聊天优化]|r 没有找到关键字\"|cffff0000%s|r\"。"
    CHANNEL_FILTER_MSG_OUT_OF_BOUND =
        "|cff00adef[聊天优化]|r 过滤列表中不存在该序号。"
    CHANNEL_FILTER_MSG_ALL_CLEAR =
        "|cff00adef[聊天优化]|r 过滤列表中的所有数据已经删除。"
    CHANNEL_FILTER_MSG_ENABLE =
        "|cff00adef[聊天优化]|r 开启聊天优化功能。"
    CHANNEL_FILTER_MSG_DISABLE =
        "|cff00adef[聊天优化]|r 关闭聊天优化功能。"
    CHANNEL_FILTER_MSG_RESET =
        "|cff00adef[聊天优化]|r 过滤列表已经被重置为缺省设置。"
    CHANNEL_FILTER_MSG_ORDERRESET =
        "|cff00adef[聊天优化]|r 查找列表已经被重置为缺省设置。"
    CHANNEL_FILTER_MSG_USAGE_PINGBI_FUNCTION =
        "\n功能：将某条文字加入到屏蔽文字列表中，凡是出现该文字字眼的频道消息将被自动屏蔽掉。"
    CHANNEL_FILTER_MSG_USAGE_PINGBI_USAGE =
        "使用格式：/guolv|cff00ff00[空格]|r+|cff00ff00[空格]|r<屏蔽文字>"
    CHANNEL_FILTER_MSG_USAGE_PINGBI_EXAMPLE = "样例：/guolv + 出售外挂"
    CHANNEL_FILTER_MSG_EMPTY_LIST = "|cffff0000不存在数据。|r"
    CHANNEL_FILTER_MSG_LIST_TITLE =
        "|cffffffff屏蔽文字列表中包括如下：|r"
    CHANNEL_FILTER_MSG_SELECT =
        "请输入\"/guolv - <序号>\"来删除列表中的屏蔽文字。"
    CHANNEL_HELP_TEXT1 = "\n|cffffffff聊天优化命令使用帮助：|r"
    CHANNEL_HELP_TEXT2 =
        "/guolv + <过滤字眼> |cff00ff00增加过滤关键字|r"
    CHANNEL_HELP_TEXT3 =
        "/guolv - <序号> |cff00ff00删除列表中的关键字|r"
    CHANNEL_HELP_TEXT4 =
        "/guolv - * |cff00ff00删除列表中的所有关键字|r"
    CHANNEL_HELP_TEXT5 =
        "/guolv * |cff00ff00显示过滤列表中的关键字|r"
    ...
    CHANNEL_FILTER_BAN_TEXT_TOOLTIP =
        "对主聊天窗口的大脚世界频道进行信息过滤,可自定义增加过滤内容关键词。"
    CHANNEL_FILTER_ORDER_TEXT = "启用关键词查找"
    CHANNEL_FILTER_ORDER_TEXT_TOOLTIP =
        "为主聊天窗口的大脚世界频道提供关键词白名单,在接收信息时筛选出仅含该关键词的信息显示。"
    CHANNEL_FILTER_LEVEL = "屏蔽等级："
    CHANNEL_FILTER_LEVEL_TEXT = "启用密语等级过滤"
    CHANNEL_FILTER_LEVEL_TEXT_TOOLTIP =
        "屏蔽低于设置等级的账号密语,死亡骑士为58级"
    CHANNEL_FILTER_whisp =
        "[大脚聊天优化]: 你起码要达到 %d 级才能和我讲话。"
    ...
    CHANNEL_FILTER_MUTE_DESC =
        "点击按钮进行切换是否屏蔽频道信息"
    CHANNEL_FILTER_MSG_BLOCKED =
        "|cff00adef[聊天优化]|r 停止接收公共频道信息。"
    CHANNEL_FILTER_MSG_UNBLOCKED =
        "|cff00adef[聊天优化]|r 继续接收公共频道信息。"
    CHANNEL_FILTER_MSG_ERR =
        "你的好友列表满了,聊天优化(ChannelFilter)插件需要你腾出2个好友空位!"
elseif (GetLocale() == "zhTW") then
    CHANNEL_FILTER_MSG_ALREADY_EXIST =
        "|cff00adef[聊天優化]|r 關鍵字\"|cffff0000%s|r\"已經存在于文字列表中。"
    CHANNEL_FILTER_MSG_ADDED =
        "|cff00adef[聊天優化]|r 關鍵字\"|cffff0000%s|r\"已經被加入至文字列表中。"
    CHANNEL_FILTER_MSG_REMOVED =
        "|cff00adef[聊天優化]|r 關鍵字\"|cffff0000%s|r\"已經從文字列表中刪除。"
    CHANNEL_FILTER_MSG_KEY_NOT_FOUND =
        "|cff00adef[聊天優化]|r 沒有找到關鍵字\"|cffff0000%s|r\"。"
    CHANNEL_FILTER_MSG_OUT_OF_BOUND =
        "|cff00adef[聊天優化]|r 過濾列表中不存在該序號。"
    CHANNEL_FILTER_MSG_ALL_CLEAR =
        "|cff00adef[聊天優化]|r 過濾列表中的所有數據已經刪除。"
    CHANNEL_FILTER_MSG_ENABLE =
        "|cff00adef[聊天優化]|r 開啓聊天優化功能。"
    CHANNEL_FILTER_MSG_DISABLE =
        "|cff00adef[聊天優化]|r 關閉聊天優化功能。"
    CHANNEL_FILTER_MSG_USAGE_PINGBI_FUNCTION =
    ...
    CHANNEL_FILTER_MSG_LIST_TITLE =
        "|cffffffff屏蔽文字列表中包括如下：|r"
    CHANNEL_FILTER_MSG_SELECT =
        "請輸入\"/guolv - <序號>\"來刪除列表中的屏蔽文字。"
    CHANNEL_HELP_TEXT1 = "\n|cffffffff聊天優化命令使用幫助：|r"
    CHANNEL_HELP_TEXT2 =
        "/guolv + <過濾字眼> |cff00ff00增加過濾關鍵字|r"
    CHANNEL_HELP_TEXT3 =
        "/guolv - <序號> |cff00ff00刪除列表中的關鍵字|r"
    CHANNEL_HELP_TEXT4 =
        "/guolv - * |cff00ff00刪除列表中的所有關鍵字|r"
    CHANNEL_HELP_TEXT5 =
        "/guolv * |cff00ff00顯示過濾列表中的關鍵字|r"
    ...
    CHANNEL_FILTER_BAN_TEXT_TOOLTIP =
        "對大腳世界頻道進行信息過濾，可自定義增加過濾內容關鍵字。"
    CHANNEL_FILTER_ORDER_TEXT = "啟用關鍵字查找"
    CHANNEL_FILTER_ORDER_TEXT_TOOLTIP =
        "為大腳世界頻道提供關鍵字白名單，在過量信息中篩選出僅含該關鍵字的信息。"
    ...
    CHANNEL_FILTER_MUTE_DESC =
        "點擊按鈕進行切換是否屏蔽頻道信息"
    CHANNEL_FILTER_MSG_BLOCKED =
        "|cff00adef[聊天优化]|r 已屏蔽公共頻道信息。"
    CHANNEL_FILTER_MSG_UNBLOCKED =
        "|cff00adef[聊天优化]|r 已停止屏蔽公共頻道信息。"
    CHANNEL_FILTER_MSG_ERR =
        "你的好友列表滿了，ChannelFilter需要你騰出2個好友空位!"
else
    CHANNEL_FILTER_MSG_ALREADY_EXIST =
        "|cff00adef[ChannelFilter]|r Keyword \"|cffff0000%s|r\" is already exist in list."
    CHANNEL_FILTER_MSG_ADDED =
        "|cff00adef[ChannelFilter]|r Keyword \"|cffff0000%s|r\" has been added into list."
    CHANNEL_FILTER_MSG_REMOVED =
        "|cff00adef[ChannelFilter]|r Keyword \"|cffff0000%s|r\" has been removed from list."
    CHANNEL_FILTER_MSG_KEY_NOT_FOUND =
        "|cff00adef[ChannelFilter]|r Can not find keyword \"|cffff0000%s|r\"。"
    CHANNEL_FILTER_MSG_OUT_OF_BOUND =
        "|cff00adef[ChannelFilter]|r The number does not exist in ignore list."
    CHANNEL_FILTER_MSG_ALL_CLEAR =
        "|cff00adef[ChannelFilter]|r All data in ignore list has been removed."
    CHANNEL_FILTER_MSG_ENABLE = "|cff00adef[ChannelFilter]|r Channel Filter On."
    CHANNEL_FILTER_MSG_DISABLE =
        "|cff00adef[ChannelFilter]|r Channel Filter Off"
    CHANNEL_FILTER_MSG_USAGE_PINGBI_FUNCTION =
        "\nFunction: Add words into ignore list to prevent from being shown in channel."
    CHANNEL_FILTER_MSG_USAGE_PINGBI_USAGE =
        "Usage: /guolv|cff00ff00[space]|r+|cff00ff00[space]|r<Ignore words>"
    ...
    CHANNEL_FILTER_MSG_LIST_TITLE =
        "|cffffffffThe follwing are included in ignore list:|r"
    CHANNEL_FILTER_MSG_SELECT =
        "Please input \"/guolv - <No.>\" to delete item in ignore list."
    CHANNEL_HELP_TEXT1 = "\n|cffffffffChannel Filter Help:|r"
    CHANNEL_HELP_TEXT2 =
        "/guolv + <words> |cff00ff00Add words into ignore list.|r"
    CHANNEL_HELP_TEXT3 = "/guolv - <No.> |cff00ff00Delete keywords.|r"
    CHANNEL_HELP_TEXT4 =
        "/guolv - * |cff00ff00Delete all keywords in ignore list.|r"
    ...
    CHANNEL_FILTER_ADD_ORDERWORD_TEXT =
        "Please type the word you want to order:"
    ...
    CHANNEL_FILTER_MSG_BLOCKED =
        "|cff00adefPublic Channels have been blocked。"
    CHANNEL_FILTER_MSG_UNBLOCKED =
        "|cff00adefPublic Channels have been unblocked。"
    CHANNEL_FILTER_MSG_ERR =
...
do
    ...
    hookFunc = function(f, msg, r, g, b, ...)
        if r == info.r and g == info.g and b == info.b then
            ...
            if not player then _, _, player = msg:find(rmvFrnd) end
            if player and filterTable[player] then return end
        end
        return addMsg(f, msg, r, g, b, ...)
    end
end
local function ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
    ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88)
    ChatFrame1:AddMessage(ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88, 1.0,
                          1.0, 0.0)
end
...
local function ChannelFilter_d9a31f63708362057d280f4e78db3ea3(
    ChannelFilter_413bf9c15ce77baa8ebf1cda4cbf4887)
    table.insert(ChannelFilter_Config.IgnoreWords,
                 ChannelFilter_413bf9c15ce77baa8ebf1cda4cbf4887)
end
local function ChannelFilter_64a0cf1bf3d70800780391512ec16e8a(
    ChannelFilter_413bf9c15ce77baa8ebf1cda4cbf4887)
    table.insert(ChannelFilter_Config.OrderWords,
                 ChannelFilter_413bf9c15ce77baa8ebf1cda4cbf4887)
end
local function ChannelFilter_31d2b1f6c943bbb6272644a023663342(
    ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    local ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88
    if (not ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae or
        ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae == "") then
        ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
            CHANNEL_FILTER_MSG_USAGE_PINGBI_FUNCTION)
        ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
            CHANNEL_FILTER_MSG_USAGE_PINGBI_USAGE)
        ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
            CHANNEL_FILTER_MSG_USAGE_PINGBI_EXAMPLE)
        return
    end
    for __index = 1, #ChannelFilter_Config.IgnoreWords, 1 do
        if (ChannelFilter_Config.IgnoreWords[__index] ==
            ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae) then
            ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
                string.format(CHANNEL_FILTER_MSG_ALREADY_EXIST,
                              ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
            ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
                ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88)
            return
    ...
    ChannelFilter_d9a31f63708362057d280f4e78db3ea3(
        ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
        string.format(CHANNEL_FILTER_MSG_ADDED,
                      ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
        ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88)
end
local function ChannelFilter_497b6c3a9fa37cdb095d6f39ba0adf2d(
    ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    local ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88
    for __index = 1, #ChannelFilter_Config.OrderWords, 1 do
        if (ChannelFilter_Config.OrderWords[__index] ==
            ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae) then
            ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
                string.format(CHANNEL_FILTER_MSG_ALREADY_EXIST,
                              ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    ...
    ChannelFilter_64a0cf1bf3d70800780391512ec16e8a(
        ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
        string.format(CHANNEL_FILTER_MSG_ADDED,
                      ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
...
local function ChannelFilter_UpdateOption()
    local ChannelFilter_99f3cf2c6f1fdfadb0fd4ab6e0843bf5,
    ...
    if (ChannelFilter_Config.Enabled) then
        ...
        if ChannelFilter_Config.BanEnabled then
            ...
            for i = 1, 2, 1 do
                ChannelFilter_99f3cf2c6f1fdfadb0fd4ab6e0843bf5 =
                    getglobal("ChannelFilterWordButton" .. i)
                ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117 =
                    getglobal("ChannelFilterWordButton" .. i .. "ButtonTextName")
                ChannelFilter_99f3cf2c6f1fdfadb0fd4ab6e0843bf5:Enable()
                ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117:SetTextColor(1.0,
                                                                            0.82,
                                                                            0)
            end
            ...
            for i = 1, 2, 1 do
                ...
                ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117:SetTextColor(0.5,
                                                                            0.5,
                                                                            0.5)
            end
        ...
        if ChannelFilter_a025bf316dae1633b9c38db34e565b5f then
            ...
            for i = 1, 2, 1 do
                ChannelFilter_99f3cf2c6f1fdfadb0fd4ab6e0843bf5 =
                    getglobal("BFIsOrderWordButton" .. i)
                ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117 =
...
local function ChannelFilter_f4a7ca345e4ea814dd44abaab06a1761(
    ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
...
local function ChannelFilter_924f23bc0b2494d114e61b77931c2730(
    ...
    if type(ChannelFilter_Config.IgnoreWords) == "table" then
        ...
        for k, v in pairs(ChannelFilter_Config.IgnoreWords) do
            if type(v) == "string" and
                string.find(
                    ChannelFilter_eed0be1c2d5f65980b06b5094460c3c5:lower(),
                    v:lower()) then
...
local function ChannelFilter_36b3da8059b22d2587b9522bc0159d52()
    local ChannelFilter_3f50417fb16be9b1078eb68d24fa9c26 =
    ...
    if (ChannelFilter_3f50417fb16be9b1078eb68d24fa9c26 == 0) then
        ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
            CHANNEL_FILTER_MSG_EMPTY_LIST)
        return
    end
    for __index = 1, ChannelFilter_3f50417fb16be9b1078eb68d24fa9c26, 1 do
        ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
            __index .. ": |cffff0000" ..
                ChannelFilter_Config.IgnoreWords[__index] .. "|r")
    end
end
...
local function ChannelFilter_074e10d4da0144099cc8ca2f67cd7a97(
    ChannelFilter_413bf9c15ce77baa8ebf1cda4cbf4887)
    local ChannelFilter_3f50417fb16be9b1078eb68d24fa9c26 =
        #ChannelFilter_Config.IgnoreWords
    for __index = 1, ChannelFilter_3f50417fb16be9b1078eb68d24fa9c26, 1 do
        if (ChannelFilter_413bf9c15ce77baa8ebf1cda4cbf4887 ==
            ChannelFilter_Config.IgnoreWords[__index]) then
            ChannelFilter_893e84a2fc9c86694109792079e8cb68(__index)
            return 1
        end
    end
end
local function ChannelFilter_6fe12d89627450702aba2e09824efef9(
    ChannelFilter_413bf9c15ce77baa8ebf1cda4cbf4887)
    local ChannelFilter_3f50417fb16be9b1078eb68d24fa9c26 =
        #ChannelFilter_Config.OrderWords
    for __index = 1, ChannelFilter_3f50417fb16be9b1078eb68d24fa9c26, 1 do
        if (ChannelFilter_413bf9c15ce77baa8ebf1cda4cbf4887 ==
            ChannelFilter_Config.OrderWords[__index]) then
            ChannelFilter_13513cc1ff10b8987c5805d20619c3cb(__index)
            return 1
        end
    end
end
local function ChannelFilter_0a3b0cbda5450bd05d7c2955e018fd9b(
    ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    if (not ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae or
        ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae == "") then
    ...
    if (not __index) then
        if (not ChannelFilter_074e10d4da0144099cc8ca2f67cd7a97(
            ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)) then
            local ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
                string.format(CHANNEL_FILTER_MSG_KEY_NOT_FOUND,
                              ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
            ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
                ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88)
        else
            local ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
                string.format(CHANNEL_FILTER_MSG_REMOVED,
                              ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
            ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
                ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88)
        end
    ...
    local ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
        string.format(CHANNEL_FILTER_MSG_REMOVED,
                      ChannelFilter_Config.IgnoreWords[__index])
    ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
        ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88)
    ChannelFilter_893e84a2fc9c86694109792079e8cb68(__index)
end
local function ChannelFilter_aa39b6e6d0c0f9203c8dfa63593baabe(
    ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    if (ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae == "*") then
    ...
    local __index = tonumber(ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    if (not __index) then
        if (not ChannelFilter_6fe12d89627450702aba2e09824efef9(
            ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)) then
            local ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
                string.format(CHANNEL_FILTER_MSG_KEY_NOT_FOUND,
                              ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    ...
    local ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88 =
        string.format(CHANNEL_FILTER_MSG_REMOVED,
                      ChannelFilter_Config.OrderWords[__index])
    ChannelFilter_cca6e81523d4253f35038608e9e1dae1(
        ChannelFilter_c9bd86bc8bc59457d49315cf5b8c5b88)
    ChannelFilter_13513cc1ff10b8987c5805d20619c3cb(__index)
end
local function ChannelFilter_b2f123d7517af7a7d51eca4375d01d8c(
    ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae)
    if (not ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae or
        ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae == "") then
    ...
    local ChannelFilter_6e4d0db7491d6883f86de390d20dbe5b,
        ...
        string.find(ChannelFilter_7739b813d90aed43ab9d0eb84ec1c1ae,
                    "([^%s]+)(%s*)(.*)")
    if (not ChannelFilter_6e4d0db7491d6883f86de390d20dbe5b) then
        ChannelFilter_0900e4822400fb50cfa421dc6b6a0106()
        return
    end
    if (ChannelFilter_934b29c1721e73eb148dc0580ccfb0b6 == "+" or
        ChannelFilter_934b29c1721e73eb148dc0580ccfb0b6 == "add") then
        ChannelFilter_31d2b1f6c943bbb6272644a023663342(
            ChannelFilter_7ae7f2ee67d777af9a48ac82a1cdd27b)
    elseif (ChannelFilter_934b29c1721e73eb148dc0580ccfb0b6 == "-" or
        ChannelFilter_934b29c1721e73eb148dc0580ccfb0b6 == "remove") then
        ChannelFilter_0a3b0cbda5450bd05d7c2955e018fd9b(
            ChannelFilter_7ae7f2ee67d777af9a48ac82a1cdd27b)
    elseif (ChannelFilter_934b29c1721e73eb148dc0580ccfb0b6 == "*" or
        ChannelFilter_934b29c1721e73eb148dc0580ccfb0b6 == "list") then
        ChannelFilter_36b3da8059b22d2587b9522bc0159d52()
...
local function ChannelFilter_ChatFrame_OnEvent(
    ...
    if (ChannelFilter_Config.Enabled) then
        ...
        if (id == SELECTED_CHAT_FRAME:GetID()) then
            ...
            if (player and Ambiguate(player, "none") ~=
                ChannelFilter_49a34e51f5b777fb9f2d3ec8bfc169f2) then
                if (event == "CHAT_MSG_TRADESKILLS" and
                    ChannelFilter_Config.mute) then return end
                if (event == "CHAT_MSG_CHANNEL" or event == "CHAT_MSG_YELL") then
                    if channel_name then
                        if not channel_name:find("世") then
                            ...
                            if ChannelFilter_Config.BanEnabled and
                                ChannelFilter_924f23bc0b2494d114e61b77931c2730(
                                    msg) then return end
                        end
                    end
                    now = time()
                    if (now - ChannelFilterFrame.last_updated > 60) then
                        ...
                        for k1, v1 in pairs(
                                          ChannelFilter_6871a3b1763bbc925b1adeb8fade8acb) do
                    ...
                    if (msg and player) then
                        if (ChannelFilter_6871a3b1763bbc925b1adeb8fade8acb[player]) then
                            for k1, v1 in
                                ipairs(
                                    ChannelFilter_6871a3b1763bbc925b1adeb8fade8acb[player]) do
                                if (channel_id and channel_id ~= 0 and now -
                                    v1["time"] < 1) then
                                    return
                                end
                                if ((v1["msg"] == msg) and
                    ...
                    if ChannelFilter_a025bf316dae1633b9c38db34e565b5f and
                        channel_name and channel_name:find("世") and
                        not IsOrderMessage(msg) then return end
                end
            end
        end
    end
...
function ChannelFilterWordButton_OnClick(self,
                                         ChannelFilter_99f3cf2c6f1fdfadb0fd4ab6e0843bf5)
    ChannelFilter_3afa8f44bbcebd4466f2606a4e264c54(self:GetID())
    ChannelFilterList_Update()
end
function ChannelFilterOrderWordButton_OnClick(self,
                                              ChannelFilter_99f3cf2c6f1fdfadb0fd4ab6e0843bf5)
...
function ChannelFilterLevelSpinBoxPrevButton_OnClick(self)
    local ChannelFilter_2361bab8b48b1041ad740bb561b21aee =
        ChannelFilterLevelSpinBoxEditBox:GetNumber()
    ChannelFilterLevelSpinBoxEditBox:SetNumber(
        ChannelFilter_2361bab8b48b1041ad740bb561b21aee - 1)
end
...
function ChannelFilterLevelSpinBoxEditBox_OnTextChange(self)
    ...
    ChannelFilter_Config.SetFliterLv =
        ChannelFilter_2361bab8b48b1041ad740bb561b21aee
end
...
function ChannelFilter_OnLoad(self)
    ...
    BLibrary("BHook"):Hook("ChatFrame_MessageEventHandler",
                           ChannelFilter_ChatFrame_OnEvent)
    ...
    ModManagement_RegisterMod("ChannelFilter",
                              [[Interface\Icons\Ability_Rogue_Disguise]],
                              CHANNEL_FILTER_TITLE, "", nil, {
        ["frame"] = "ChannelFilterOptionFrame",
        ["offsetx"] = 313,
        ["offsety"] = -108
    }, {[7] = true})
end
function ChannelFilter_OnEvent(self, event, ...)
    if (event == "ADDON_LOADED" and select(1, ...) == "ChannelFilter") then
        ...
        ChannelFilter_Config.OrderWords =
            ChannelFilter_Config.OrderWords or
                ChannelFilter_NewOrderWords_Default
        ChannelFilter_Config.IgnoreWords =
            ChannelFilter_Config.IgnoreWords or
                ChannelFilter_NewIgnoreWords_Default
        ChannelFilter_bfda630401df06fcd17a268bf2416b36()
        C_FriendList.ShowFriends()
        good[UnitName("player")] = true
        ChatFrame_AddMessageEventFilter("CHAT_MSG_WHISPER", function(...)
            if not ChannelFilter_Config.FilterLevel then return end
            local f, _, _, player, _, _, _, flag, _, _, _, _, id, guid = ...
            if flag == "GM" or flag == "DEV" then return end
            local trimmedPlayer = Ambiguate(player, "none")
            if good[trimmedPlayer] or UnitIsInMyGuild(trimmedPlayer) then
                return
            end
            ...
            for i = 1, num do
                ...
                for j = 1, toon do
                    local _, rName, rGame, rServer =
                        BNGetFriendGameAccountInfo(i, j)
                    if rName == trimmedPlayer and rGame == "WoW" and rServer ==
                        GetRealmName() then
            ...
            if IsAddOnLoaded("WIM") and f ~= "WIM_workerFrame" then
                return true
            end
            if IsAddOnLoaded("Cellular") and f ~= "Cellular" then
                return true
            end
            if not maybe[trimmedPlayer] then
                maybe[trimmedPlayer] = {}
            end
            if not maybe[trimmedPlayer][f] then
                maybe[trimmedPlayer][f] = {}
            end
            ...
            local level = ChannelFilter_Config.SetFliterLv and
                              tonumber(ChannelFilter_Config.SetFliterLv) + 1 or
                              2
            if englishClass == "DEATHKNIGHT" and level < 58 then
                level = 58
            end
            if not filterTable[trimmedPlayer] or filterTable[trimmedPlayer] ~=
                level then
                filterTable[trimmedPlayer] = level
                maybeGood = trimmedPlayer
                    ...
                    for _, v in pairs(maybe[filter]) do
                        for _, p in pairs(v) do
                            if IsAddOnLoaded("WIM") then
                                WIM.modules.WhisperEngine:CHAT_MSG_WHISPER(
                                    select(3, unpack(p)))
                            elseif IsAddOnLoaded("Cellular") then
                                local _, _, a1, a2, _, _, _, a6, _, _, _, _,
                                      a11, a12 = unpack(p)
                                Cellular:IncomingMessage(a2, a1, a6, nil, a11,
                                                         a12)
                            else
    ...
    elseif event == "FRIENDLIST_UPDATE" then
                        ...
                        for _, v in pairs(maybe[player]) do
                            for _, p in pairs(v) do
                                ...
                                elseif IsAddOnLoaded("Cellular") then
                                    local _, _, a1, a2, _, _, _, a6, _, _, _, _,
                                          a11, a12 = unpack(p)
                                    Cellular:IncomingMessage(a2, a1, a6, nil,
                                                             a11, a12)
                                else
                                    ChatFrame_MessageEventHandler(unpack(p))
                                end
        ...
        if maybeGood then maybeGood = nil end
    end
end
function ChannelFilterList_Update()
    local ChannelFilter_6a6e9e50c54c6dd20e3a8c58f5cd1de2 =
        ChannelFilter_36e4b551303d04c14eb2146a9605928c()
    local ChannelFilter_6b538e337e77d6490b0a402f4d47e002 =
        ChannelFilter_6dd3dc592a99bd644ef45b590dda7fc0()
    local ChannelFilter_47eefd9873494a7ac112542867e34eda =
        FauxScrollFrame_GetOffset(ChannelFilterScrollFrame)
    local ChannelFilter_a053f19281d0e89960b324eb13316e5f =
        FauxScrollFrame_GetOffset(ChannelFilterOrderScrollFrame)
    local ChannelFilter_48666c3db4d9f4d39e05d6ea45236773 =
        ChannelFilter_ff376af5724fd739f29ed8014d542a7b()
    local ChannelFilter_48246f1cbee24a582e957998166d9f9b =
        ChannelFilter_d0051d21b741a038fff5c35e3d912fd7()
    local ChannelFilter_910e55c928d53443ec341f365a151493,
          ChannelFilter_653ea955459e0e801c4f1325b13556b4,
          ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117
    if (ChannelFilter_48666c3db4d9f4d39e05d6ea45236773 and
        ChannelFilter_Config.Enabled and ChannelFilter_Config.BanEnabled and
        ChannelFilter_48666c3db4d9f4d39e05d6ea45236773 <=
        ChannelFilter_6a6e9e50c54c6dd20e3a8c58f5cd1de2) then
        ChannelFilterRemoveButton:Enable()
    else
        ChannelFilterRemoveButton:Disable()
    end
    if (ChannelFilter_48246f1cbee24a582e957998166d9f9b and
        ChannelFilter_Config.Enabled and
        ChannelFilter_a025bf316dae1633b9c38db34e565b5f and
        ChannelFilter_48246f1cbee24a582e957998166d9f9b <=
        ChannelFilter_6b538e337e77d6490b0a402f4d47e002) then
        ChannelFilterOrderRemoveButton:Enable()
    else
        ChannelFilterOrderRemoveButton:Disable()
    end
    for ChannelFilter_e914904fab9d05d3f54d52bfc31a0f3f = 1, 2, 1 do
        ChannelFilter_910e55c928d53443ec341f365a151493 =
            ChannelFilter_47eefd9873494a7ac112542867e34eda +
                ChannelFilter_e914904fab9d05d3f54d52bfc31a0f3f
        ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117 =
            ChannelFilter_83db3bfe22406ceb77f6b9fa06ae4142(
                ChannelFilter_910e55c928d53443ec341f365a151493)
        getglobal("ChannelFilterWordButton" ..
                      ChannelFilter_e914904fab9d05d3f54d52bfc31a0f3f ..
                      "ButtonTextName"):SetText(
            ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117)
        ChannelFilter_653ea955459e0e801c4f1325b13556b4 =
            getglobal("ChannelFilterWordButton" ..
                          ChannelFilter_e914904fab9d05d3f54d52bfc31a0f3f)
        ChannelFilter_653ea955459e0e801c4f1325b13556b4:SetID(
            ChannelFilter_910e55c928d53443ec341f365a151493)
        if (ChannelFilter_910e55c928d53443ec341f365a151493 ==
            ChannelFilter_48666c3db4d9f4d39e05d6ea45236773 and
            ChannelFilter_Config.Enabled and ChannelFilter_Config.BanEnabled) then
    ...
    for ChannelFilter_e914904fab9d05d3f54d52bfc31a0f3f = 1, 2, 1 do
        ChannelFilter_910e55c928d53443ec341f365a151493 =
            ChannelFilter_a053f19281d0e89960b324eb13316e5f +
                ChannelFilter_e914904fab9d05d3f54d52bfc31a0f3f
        ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117 =
            ChannelFilter_3fc08f96feeb7a0757d43d3c0b586a37(
                ChannelFilter_910e55c928d53443ec341f365a151493)
        getglobal("BFIsOrderWordButton" ..
                      ChannelFilter_e914904fab9d05d3f54d52bfc31a0f3f ..
                      "ButtonTextName"):SetText(
            ChannelFilter_e6955c64cf39bdb23dc86de1a9ec2117)
        ChannelFilter_653ea955459e0e801c4f1325b13556b4 =
        ...
        ChannelFilter_653ea955459e0e801c4f1325b13556b4:SetID(
            ChannelFilter_910e55c928d53443ec341f365a151493)
        if (ChannelFilter_910e55c928d53443ec341f365a151493 ==
            ChannelFilter_48246f1cbee24a582e957998166d9f9b and
            ChannelFilter_Config.Enabled and
            ChannelFilter_a025bf316dae1633b9c38db34e565b5f) then
            ChannelFilter_653ea955459e0e801c4f1325b13556b4:LockHighlight()
        else
            ChannelFilter_653ea955459e0e801c4f1325b13556b4:UnlockHighlight()
        end
    ...
    if (ChannelFilter_Config.Enabled and ChannelFilter_Config.BanEnabled) then
        FauxScrollFrame_Update(ChannelFilterScrollFrame,
                               ChannelFilter_6a6e9e50c54c6dd20e3a8c58f5cd1de2,
                               2, 16)
    else
        FauxScrollFrame_Update(ChannelFilterScrollFrame, 1, 2, 16)
    end
    if (ChannelFilter_Config.Enabled and
        ChannelFilter_a025bf316dae1633b9c38db34e565b5f) then
        FauxScrollFrame_Update(ChannelFilterOrderScrollFrame,
                               ChannelFilter_6b538e337e77d6490b0a402f4d47e002,
                               2, 16)
    else
...
StaticPopupDialogs["CHANNEL_FILTER_ADD_ORDERWORD"] =
    {
        ...
        maxLetters = 12,
        OnAccept = function(self)
            ChannelFilter_497b6c3a9fa37cdb095d6f39ba0adf2d(
                self.editBox:GetText())
            ChannelFilterList_Update()
        end,
        OnShow = function(self)
...
function ChannelFilterButton_OnEnter(self)
    if (self.tooltip) then
        ...
        if (self.caption) then
            ...
            ModManagementTooltip:AddLine(self.tooltip, NORMAL_FONT_COLOR.r,
                                         NORMAL_FONT_COLOR.g,
                                         NORMAL_FONT_COLOR.b, 1)
        else
            ModManagementTooltip:SetText(self.tooltip, NORMAL_FONT_COLOR.r,
                                         NORMAL_FONT_COLOR.g,
                                         NORMAL_FONT_COLOR.b, 1, 1)
        end
