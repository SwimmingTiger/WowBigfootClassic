...
function Addon:PLAYER_LOGIN()
 ...
 if db.mapButton then
	...
	local dropDownMenu = L_Create_UIDropDownMenu("HandyNotes_NPCsBCCDropDownMenu", button)
	L_UIDropDownMenu_Initialize(dropDownMenu, HandyNotes_NPCsBCCDropDownMenu, "MENU")
