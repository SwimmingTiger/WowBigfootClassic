...
if (GetLocale() == "zhCN") then
    ...
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Show unit price"] = "显示拍卖物品的单价"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff00ff00Add|r %s"] = "|cff00ff00添加|r %s"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffff0000Remove|r %s"] = "|cffff0000移除|r %s"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["[%s] has been removed from query list."] = "[%s] 已成功移除出查询列表!"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["[%s] has been add from query list."] = "[%s] 已成功添加入查询列表!"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["The item has been bid"] = "该物品已有人竞拍"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Click to select item to query"] = "点击选择查询物品"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEEach for sell: |r"] = "|cff7B68EE出售单价: |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EETotal for sell: |r"] = "|cff7B68EE出售总价: |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEStart bid: |r"] = "|cff7B68EE起拍单价: |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEStart group bid(%d): |r"] = "|cff7B68EE每组拍价(%d): |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEGroup bid(%d%%): |r"] = "|cff7B68EE竞标单价(%d%%): |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEBid out(%d%%): |r"] = "|cff7B68EE一口单价(%d%%): |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffFFFAFAStack: %d|r"] = "|cffFFFAFA每组堆叠: %d|r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffFFE4B5Item level: %d|r"] = "|cffFFE4B5物品等级: %d|r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffFFD700Use(%s):|r |cffFF00FF%s|r"] =
        "|cffFFD700用途(%s):|r |cffFF00FF%s|r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffFFD700Use:|r |cffFFD700%s|r"] = "|cffFFD700用途:|r |cffFFD700%s|r"
    ...
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["All information about auction items will be cleared, Are you sure?"] =
        "确认清除所有物品的拍卖信息?"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["All information about auction items were cleared!"] = "成功清除了所有物品的拍卖信息!"
elseif (GetLocale() == "zhTW") then
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Item Info"] = "物品信息"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Unit Price"] = "單價"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Show unit price"] = "顯示拍賣物品的單價"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff00ff00Add|r %s"] = "|cff00ff00添加|r %s"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffff0000Remove|r %s"] = "|cffff0000移除|r %s"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["[%s] has been removed from query list."] = "[%s] 已成功移除出查詢列表!"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["[%s] has been add from query list."] = "[%s] 已成功添加入查詢列表!"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["The item has been bid"] = "該物品已有人競拍"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Click to select item to query"] = "點擊選擇查詢物品"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEEach for sell: |r"] = "|cff7B68EE出售單價: |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EETotal for sell: |r"] = "|cff7B68EE出售總價: |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEStart bid: |r"] = "|cff7B68EE起拍單價: |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEStart group bid(%d): |r"] = "|cff7B68EE每組拍價(%d): |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEGroup bid(%d%%): |r"] = "|cff7B68EE競標單價(%d%%): |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEBid out(%d%%): |r"] = "|cff7B68EE直購單價(%d%%): |r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffFFFAFAStack: %d|r"] = "|cffFFFAFA每組堆疊: %d|r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffFFE4B5Item level: %d|r"] = "|cffFFE4B5物品等級: %d|r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffFFD700Use(%s):|r |cffFF00FF%s|r"] =
        "|cffFFD700用途(%s):|r |cffFF00FF%s|r"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffFFD700Use:|r |cffFFD700%s|r"] = "|cffFFD700用途:|r |cffFFD700%s|r"
    ...
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["All information about auction items will be cleared, Are you sure?"] =
        "確認清除所有物品的拍賣資訊?"
    ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["All information about auction items were cleared!"] = "成功清除了所有物品的拍賣資訊!"
end
ItemInfo_Config = {["rname"] = {}, ["auctionPrice"] = {}, ["ShowUnitPrice"] = false}
...
local ItemInfo_430372cffccf1f7472976dd445422a1b =
    BLibrary("BInfo", "chat", ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Item Info"])
local ItemInfo_2140bb9f1f51de36bdf1e48056b92f6d = "Interface\\PvPRankBadges\\PvPRank09.blp"
...
StaticPopupDialogs["CLEAR_AUCTION_INFOMATION"] = {
    ...
    text = ItemInfo_27564b0f8fc08d6bd0345695785ce4b6[
        "All information about auction items will be cleared, Are you sure?"
    ],
    button1 = ACCEPT,
    button2 = CANCEL,
...
local function ItemInfo_d38674d7124558fa892d69c68668bd01(ItemInfo_e498578b78aa0db9c45f30f87d63debc)
    if
        (not ItemInfo_e498578b78aa0db9c45f30f87d63debc or type(ItemInfo_e498578b78aa0db9c45f30f87d63debc) ~= "string" or
            ItemInfo_e498578b78aa0db9c45f30f87d63debc == "")
     then
        return
    end
    local _, _, ItemInfo_82541cdf49ca614c4b9f2a16a07469a0 =
        strfind(ItemInfo_e498578b78aa0db9c45f30f87d63debc, "\124c%x+\124Hitem:(%d+):.+\124h%[.-%]\124h\124r")
    if not ItemInfo_82541cdf49ca614c4b9f2a16a07469a0 then
        return
    end
    return tonumber(ItemInfo_82541cdf49ca614c4b9f2a16a07469a0)
end
local function ItemInfo_00c082a9be8a1d8e162a78021c9506b5(self, ItemInfo_8983c60d66c8593ec7165ea9dbedb584)
    if (ItemInfo_8983c60d66c8593ec7165ea9dbedb584 and type(ItemInfo_8983c60d66c8593ec7165ea9dbedb584) == "string") then
...
local function ItemInfo_64ac251a2fd0f26a37b32e9c8e3c7c66(self, ItemInfo_8983c60d66c8593ec7165ea9dbedb584)
...
local function ItemInfo_ae5f860635f34632b40407a4193e0abd(ItemInfo_8983c60d66c8593ec7165ea9dbedb584)
    if not ItemInfo_8983c60d66c8593ec7165ea9dbedb584 then
        return
    end
    for ItemInfo_413bf9c15ce77baa8ebf1cda4cbf4887, ItemInfo_2361bab8b48b1041ad740bb561b21aee in ipairs(
        ItemInfo_Config.rname
    ) do
        if (ItemInfo_2361bab8b48b1041ad740bb561b21aee == ItemInfo_8983c60d66c8593ec7165ea9dbedb584) then
            return ItemInfo_413bf9c15ce77baa8ebf1cda4cbf4887
        end
    end
end
local function ItemInfo_52de863f6e4805efe3608c438f3dde1b()
    local ItemInfo_a44ecbf575d7f2eca081a0592e8d84fa = {value = 0, notCheckable = 1}
    local ItemInfo_8983c60d66c8593ec7165ea9dbedb584 = BrowseName:GetText()
    local ItemInfo_6d6c07a1e02fdc49f88cbb276184ce42
    if (ItemInfo_8983c60d66c8593ec7165ea9dbedb584 and ItemInfo_8983c60d66c8593ec7165ea9dbedb584 ~= "") then
        ItemInfo_c3eba7ecdad0c747cae12732334b4e0a =
            ItemInfo_ae5f860635f34632b40407a4193e0abd(ItemInfo_8983c60d66c8593ec7165ea9dbedb584)
        if (ItemInfo_c3eba7ecdad0c747cae12732334b4e0a) then
            ItemInfo_a44ecbf575d7f2eca081a0592e8d84fa.func = ItemInfo_2f54ba7e2e2035f7cae3d0a3d6ea3eb3
            ItemInfo_a44ecbf575d7f2eca081a0592e8d84fa.text =
                format(
                ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cffff0000Remove|r %s"],
                ItemInfo_8983c60d66c8593ec7165ea9dbedb584
            )
        elseif (#(ItemInfo_Config["rname"]) < ItemInfo_7d74c6a6be304992d3e391143d721868) then
            ItemInfo_a44ecbf575d7f2eca081a0592e8d84fa.func = ItemInfo_64ac251a2fd0f26a37b32e9c8e3c7c66
            ItemInfo_a44ecbf575d7f2eca081a0592e8d84fa.arg1 = ItemInfo_8983c60d66c8593ec7165ea9dbedb584
            ItemInfo_a44ecbf575d7f2eca081a0592e8d84fa.text =
                format(
    ...
    for ItemInfo_413bf9c15ce77baa8ebf1cda4cbf4887, ItemInfo_8983c60d66c8593ec7165ea9dbedb584 in ipairs(
        ItemInfo_Config.rname
    ) do
        ...
        if (ItemInfo_413bf9c15ce77baa8ebf1cda4cbf4887 == ItemInfo_c3eba7ecdad0c747cae12732334b4e0a) then
...
local function ItemInfo_648afc4e523bce211ef4a10aead7bc38()
    for ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f = 1, NUM_BROWSE_TO_DISPLAY do
        local ItemInfo_99f3cf2c6f1fdfadb0fd4ab6e0843bf5 =
            getglobal("BrowseButton" .. ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f)
        local ItemInfo_411b8aa6d5954c6020f0b9c9e80e847a =
            CreateFrame(
            "Button",
            ItemInfo_99f3cf2c6f1fdfadb0fd4ab6e0843bf5:GetName() .. "Texture",
            ItemInfo_99f3cf2c6f1fdfadb0fd4ab6e0843bf5
        )
        local ItemInfo_9248008bbb6d0ee7ce13f6ee45680051 =
            ItemInfo_411b8aa6d5954c6020f0b9c9e80e847a:CreateTexture("", "ARTWORK")
        ...
        ItemInfo_9248008bbb6d0ee7ce13f6ee45680051:SetAllPoints(ItemInfo_411b8aa6d5954c6020f0b9c9e80e847a)
        ItemInfo_9248008bbb6d0ee7ce13f6ee45680051:SetTexture(ItemInfo_2140bb9f1f51de36bdf1e48056b92f6d)
        ItemInfo_411b8aa6d5954c6020f0b9c9e80e847a:SetPoint(
            "TOPLEFT",
            ItemInfo_99f3cf2c6f1fdfadb0fd4ab6e0843bf5,
            "TOPLEFT",
            185,
        ...
        ItemInfo_411b8aa6d5954c6020f0b9c9e80e847a:SetScript(
            "OnEnter",
            function(self)
                GameTooltip:SetOwner(ItemInfo_411b8aa6d5954c6020f0b9c9e80e847a, "ANCHOR_BOTTOMRIGHT", 20, 20)
                GameTooltip:AddLine(ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["The item has been bid"])
                GameTooltip:Show()
            end
        )
        ItemInfo_411b8aa6d5954c6020f0b9c9e80e847a:SetScript(
    ...
    local ItemInfo_a8644751c725025897986966350ca5bf =
        CreateFrame("Button", "BrowseNameSort", AuctionFrameBrowse, "AuctionSortButtonTemplate")
    ...
    ItemInfo_a8644751c725025897986966350ca5bf:SetPoint("TOPLEFT", AuctionFrameBrowse, "TOPLEFT", 186, -82)
    ItemInfo_a8644751c725025897986966350ca5bf.order = false
    ItemInfo_a8644751c725025897986966350ca5bf:SetScript(
        "OnClick",
        function(self, ...)
            self.order = not self.order
            AuctionFrame_SetSort("list", "name", self.order)
            AuctionFrameBrowse_Search()
            SortButton_UpdateArrow(ItemInfo_a8644751c725025897986966350ca5bf, "list", "name")
        end
    )
    hooksecurefunc(
    ...
    BrowseQualitySort:SetPoint("LEFT", ItemInfo_a8644751c725025897986966350ca5bf, "RIGHT", -2, 0)
    local ItemInfo_1dde068a1391636ae83e03bd798f5914 =
        CreateFrame("CheckButton", "ShowOnUnitPriceCheckButton", BrowseCurrentBidSort, "UICheckButtonTemplate")
    ...
    getglobal(ItemInfo_1dde068a1391636ae83e03bd798f5914:GetName() .. "Text"):SetText(
        ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Unit Price"],
        1,
        1,
        1
    )
    ItemInfo_1dde068a1391636ae83e03bd798f5914:SetPoint("LEFT", BrowseCurrentBidSort, "LEFT", 110, -2)
    ItemInfo_1dde068a1391636ae83e03bd798f5914:SetScript(
        "OnEnter",
        function(self)
            GameTooltip:SetOwner(self, "ANCHOR_RIGHT", -60, 0)
            GameTooltip:AddLine(ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Show unit price"])
            GameTooltip:Show()
        end
    )
    ItemInfo_1dde068a1391636ae83e03bd798f5914:SetScript(
    ...
    ItemInfo_1dde068a1391636ae83e03bd798f5914:SetScript(
        "OnClick",
        function(self)
            ItemInfo_Config.ShowUnitPrice = ItemInfo_1dde068a1391636ae83e03bd798f5914:GetChecked()
    ...
    ItemInfo_1dde068a1391636ae83e03bd798f5914:SetScript(
        "OnShow",
        function(self)
            ItemInfo_1dde068a1391636ae83e03bd798f5914:SetChecked(ItemInfo_Config.ShowUnitPrice)
        end
    )
    local ItemInfo_8e74cec0f43558c7a448228e3cd6dc8b =
        CreateFrame("Frame", "SaveSearchName_DropDown", BrowseName, "BDropDownMenuTemplate")
    local ItemInfo_7ea66450f0a3bcc8fa0da90afc9e7fda = ItemInfo_8e74cec0f43558c7a448228e3cd6dc8b:GetName()
    ItemInfo_8e74cec0f43558c7a448228e3cd6dc8b:SetID(1)
    ItemInfo_8e74cec0f43558c7a448228e3cd6dc8b:SetPoint("LEFT", BrowseName, "LEFT", 13, -3)
    ItemInfo_8e74cec0f43558c7a448228e3cd6dc8b:SetScript(
        "OnShow",
        function()
            ...
            getglobal(ItemInfo_7ea66450f0a3bcc8fa0da90afc9e7fda .. "ButtonNormalTexture"):SetTexture(
                "Interface\\ChatFrame\\UI-ChatIcon-ScrollDown-Up"
            )
            getglobal(ItemInfo_7ea66450f0a3bcc8fa0da90afc9e7fda .. "ButtonDisabledTexture"):SetTexture(
                "Interface\\ChatFrame\\UI-ChatIcon-ScrollDown-Disabled"
            )
            getglobal(ItemInfo_7ea66450f0a3bcc8fa0da90afc9e7fda .. "ButtonPushedTexture"):SetTexture(
                "Interface\\ChatFrame\\UI-ChatIcon-ScrollDown-Down"
            )
            getglobal(ItemInfo_7ea66450f0a3bcc8fa0da90afc9e7fda .. "ButtonHighlightTexture"):SetTexture(
                "Interface\\Buttons\\UI-Common-MouseHilight"
            )
            BDropDownMenu_SetSelectedValue(BrowseDropDown, -1)
        end
    )
    local ItemInfo_1db96014cef6489dcf324f3ef7b365bd = getglobal(ItemInfo_7ea66450f0a3bcc8fa0da90afc9e7fda .. "Button")
    ItemInfo_1db96014cef6489dcf324f3ef7b365bd:SetScript(
        "OnEnter",
        function(ItemInfo_c933410cf37b41b19e2f71899bab1b9b)
            GameTooltip:SetOwner(ItemInfo_1db96014cef6489dcf324f3ef7b365bd, "ANCHOR_RIGHT")
            GameTooltip:AddLine(ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["Click to select item to query"])
            GameTooltip:Show()
        end
    )
    ItemInfo_1db96014cef6489dcf324f3ef7b365bd:SetScript(
...
local function ItemInfo_a445b92afd50dd0eb5fc856b59495961(self, event, ...)
    if (event == "NEW_AUCTION_UPDATE") then
        local ItemInfo_8983c60d66c8593ec7165ea9dbedb584,
            ...
            ItemInfo_153c09d58f6a5f5b4e49d6f46f5b1395 = GetAuctionSellItemInfo()
        ...
        if ItemInfo_Config.auctionPrice[ItemInfo_8983c60d66c8593ec7165ea9dbedb584] then
            ...
            if AuctionFrameAuctions.priceType == 1 then
                MoneyInputFrame_SetCopper(StartPrice, ItemInfo_8e6c2aaeb6b11f026ff5cb0a29aebe68[1])
                MoneyInputFrame_SetCopper(BuyoutPrice, ItemInfo_8e6c2aaeb6b11f026ff5cb0a29aebe68[2])
            else
                MoneyInputFrame_SetCopper(
                    StartPrice,
                    ItemInfo_8e6c2aaeb6b11f026ff5cb0a29aebe68[1] * ItemInfo_3f50417fb16be9b1078eb68d24fa9c26
                )
                MoneyInputFrame_SetCopper(
                    BuyoutPrice,
                    ItemInfo_8e6c2aaeb6b11f026ff5cb0a29aebe68[2] * ItemInfo_3f50417fb16be9b1078eb68d24fa9c26
                )
            end
        else
            local ItemInfo_72715f78e65bb2b7bd0a142e3e8051d5, ItemInfo_fafa209f325a6db4a33bfb03c1262213
            if AuctionFrameAuctions.priceType == 1 then
                ItemInfo_72715f78e65bb2b7bd0a142e3e8051d5 =
                    max(floor(ItemInfo_153c09d58f6a5f5b4e49d6f46f5b1395 * BUY_OUT_SCALE), 100)
                ItemInfo_fafa209f325a6db4a33bfb03c1262213 =
                    max(floor(ItemInfo_153c09d58f6a5f5b4e49d6f46f5b1395 * BUY_OUT_SCALE) * BUY_OUT_SCALE, 150)
            else
                ItemInfo_72715f78e65bb2b7bd0a142e3e8051d5 =
                    max(floor(ItemInfo_8a3f6cb862abe97e1e5c304b618abf6c * BUY_OUT_SCALE), 100)
                ItemInfo_fafa209f325a6db4a33bfb03c1262213 =
                    max(floor(ItemInfo_8a3f6cb862abe97e1e5c304b618abf6c * BUY_OUT_SCALE) * BUY_OUT_SCALE, 150)
            end
            MoneyInputFrame_SetCopper(StartPrice, ItemInfo_72715f78e65bb2b7bd0a142e3e8051d5)
            MoneyInputFrame_SetCopper(BuyoutPrice, ItemInfo_fafa209f325a6db4a33bfb03c1262213)
        end
        UpdateDeposit()
    end
end
local function ItemInfo_816bad5b26d812a70e00dd16c033428d(self, ...)
    if II_LAST_ITEM_AUCTIONED then
        ...
        if not PriceDropDown:IsShown() or AuctionFrameAuctions.priceType == 1 then
            ItemInfo_Config.auctionPrice[II_LAST_ITEM_AUCTIONED] = {bid, buyout, duration}
        else
            local count = AuctionsStackSizeEntry:GetNumber()
            ItemInfo_Config.auctionPrice[II_LAST_ITEM_AUCTIONED] = {
                math.floor(bid / count),
                math.floor(buyout / count),
                duration
            }
        end
    end
...
local function ItemInfo_0c52d557e2660c2afbb6a0ff84149692(...)
    ...
    local ItemInfo_98b436aae97b9941de81152428c81208 = FauxScrollFrame_GetOffset(BrowseScrollFrame)
    for ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f = 1, NUM_BROWSE_TO_DISPLAY do
        ItemInfo_45739690061ee7945c14d8a8937f5395 =
            ItemInfo_98b436aae97b9941de81152428c81208 + ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f
        ItemInfo_81b1f54fc01b0ac2d57753b4b077836c = "BrowseButton" .. ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f
        ItemInfo_9248008bbb6d0ee7ce13f6ee45680051 = getglobal(ItemInfo_81b1f54fc01b0ac2d57753b4b077836c .. "Texture")
        ItemInfo_34694ab57c8a9444e5e6faf24cae8213 = getglobal(ItemInfo_81b1f54fc01b0ac2d57753b4b077836c .. "MoneyFrame")
        ItemInfo_410bf65e3d9dd0c6862d3e4426dce982 =
            getglobal(ItemInfo_81b1f54fc01b0ac2d57753b4b077836c .. "BuyoutFrameMoney")
        _,
            _,
            ItemInfo_3f50417fb16be9b1078eb68d24fa9c26,
            _,
        ...
        if (ItemInfo_7034464da73cfb8515c09445b0c4bc7f == 0) then
            ...
            ItemInfo_4f0f0bd269d3aed0b523907026ae2a31 = ItemInfo_aa48e4d59c305916bb09e3d3ecaa76d0
        else
            ItemInfo_9248008bbb6d0ee7ce13f6ee45680051:Show()
            ItemInfo_4f0f0bd269d3aed0b523907026ae2a31 = ItemInfo_7034464da73cfb8515c09445b0c4bc7f
        end
        if (ItemInfo_Config.ShowUnitPrice) then
            ItemInfo_4f0f0bd269d3aed0b523907026ae2a31 =
                math.floor(ItemInfo_4f0f0bd269d3aed0b523907026ae2a31 / ItemInfo_3f50417fb16be9b1078eb68d24fa9c26 + 0.5)
            if (ItemInfo_8126704607de771b02f09d547c67706b > 0) then
                ItemInfo_8126704607de771b02f09d547c67706b =
                    math.floor(
                    ItemInfo_8126704607de771b02f09d547c67706b / ItemInfo_3f50417fb16be9b1078eb68d24fa9c26 + 0.5
                )
            end
        end
...
local function ItemInfo_HookAuctionUI()
    ...
    ItemInfo_01df612d60ced2cfa8ff3c8d1a39e47d:Hook(
        "AuctionFrameBrowse_Update",
    ...
    for i = 1, NUM_CONTAINER_FRAMES do
        for j = 1, MAX_CONTAINER_ITEMS do
            ...
            if f then
                ItemInfo_6cab35024b87790a8a354e65a303109a(f, "PreClick", ItemInfo_ContainerItemPreClick)
            end
        end
    end
end
local function ItemInfo_OnAutionEnable(switch)
    if (IsAddOnLoaded("Blizzard_AuctionUI")) then
        if (switch) then
            ...
            for ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f = 1, NUM_BROWSE_TO_DISPLAY do
                local ItemInfo_9248008bbb6d0ee7ce13f6ee45680051 =
                    getglobal("BrowseButton" .. ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f .. "Texture")
                ItemInfo_9248008bbb6d0ee7ce13f6ee45680051:Hide()
            end
        end
    end
...
local function ItemInfo_65407381b6a3a856c701a9dc4af83c36(self)
    ...
    for ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f = 1, 6 do
        local ItemInfo_8983c60d66c8593ec7165ea9dbedb584 =
            format(selfName .. "IIMoneyFrame%d", ItemInfo_e914904fab9d05d3f54d52bfc31a0f3f)
        if
            (getglobal(ItemInfo_8983c60d66c8593ec7165ea9dbedb584) and
                getglobal(ItemInfo_8983c60d66c8593ec7165ea9dbedb584):IsShown())
         then
...
local function ItemInfo_4ff31b8a539fa2cf7990edc09e693395(
    ...
    ItemInfo_45739690061ee7945c14d8a8937f5395)
    if
        (InCombatLockdown() or not ItemInfo_acaec9f163947cc37d561bc125c83a9f or
            not ItemInfo_22757db962500df3e5f8bfed4be92671)
     then
        return
    end
    local ItemInfo_dc0ed675b3e32a9dd9d4058182798c95 = ItemInfo_411b8aa6d5954c6020f0b9c9e80e847a or GameTooltip
    local ItemInfo_e975387afdf29ffdf25670c037f683f0 = ItemInfo_dc0ed675b3e32a9dd9d4058182798c95:GetName()
    local ItemInfo_8983c60d66c8593ec7165ea9dbedb584 =
        format(
        ItemInfo_e975387afdf29ffdf25670c037f683f0 .. "IIMoneyFrame%d",
        tonumber(ItemInfo_45739690061ee7945c14d8a8937f5395)
    )
    local ItemInfo_34694ab57c8a9444e5e6faf24cae8213 = getglobal(ItemInfo_8983c60d66c8593ec7165ea9dbedb584)
    ...
    if ItemInfo_22757db962500df3e5f8bfed4be92671 > 0 then
        MoneyFrame_Update(ItemInfo_8983c60d66c8593ec7165ea9dbedb584, ItemInfo_22757db962500df3e5f8bfed4be92671)
        local leftText =
            getglobal(
            format(ItemInfo_e975387afdf29ffdf25670c037f683f0 .. "TextLeft%d", ItemInfo_acaec9f163947cc37d561bc125c83a9f)
        )
        ItemInfo_34694ab57c8a9444e5e6faf24cae8213:ClearAllPoints()
        ItemInfo_34694ab57c8a9444e5e6faf24cae8213:SetPoint(
            "RIGHT",
            ItemInfo_dc0ed675b3e32a9dd9d4058182798c95,
            "RIGHT",
            0,
        ...
        ItemInfo_34694ab57c8a9444e5e6faf24cae8213:SetPoint("TOP", leftText, "TOP", 0, 0)
        local lastWidth =
            math.max(
            ItemInfo_dc0ed675b3e32a9dd9d4058182798c95:GetWidth(),
            ItemInfo_34694ab57c8a9444e5e6faf24cae8213:GetWidth() + leftText:GetWidth() + 4
        )
...
local function ItemInfo_e82cbfba30c104197e9c9c6d43949874(self, ...)
    if not ItemInfo_7a0f86110e37241bb46f51b3e0530b56 then
        return
    end
    local ItemInfo_1f194f793e9150819d886c66d5bc23b5, ItemInfo_e498578b78aa0db9c45f30f87d63debc = self:GetItem()
    if (not ItemInfo_1f194f793e9150819d886c66d5bc23b5 or type(ItemInfo_1f194f793e9150819d886c66d5bc23b5) ~= "string") then
        return
    end
    local _,
        _,
        ...
        _,
        _itemTexture,
        _itemPrice = GetItemInfo(ItemInfo_e498578b78aa0db9c45f30f87d63debc)
    local ItemInfo_de3cbe286618f666df102dd52371d2ef =
        ItemInfo_d38674d7124558fa892d69c68668bd01(ItemInfo_e498578b78aa0db9c45f30f87d63debc)
    if not ItemInfo_de3cbe286618f666df102dd52371d2ef then
        return
    end
    ItemInfo_65407381b6a3a856c701a9dc4af83c36(self)
    if (II_Config.GemInfo) then
        local gemLink, gemLv
        local relic1, relic2, relic3
        _, _, _, relic1, relic2, relic3 = strsplit(":", ItemInfo_e498578b78aa0db9c45f30f87d63debc)
        local relics = {relic1, relic2, relic3}
        for i = 1, #relics do
            _, gemLink = GetItemGem(ItemInfo_e498578b78aa0db9c45f30f87d63debc, i)
            if gemLink then
                local relicType, artifactLevelGain
                if RelicSlots[ItemInfo_de3cbe286618f666df102dd52371d2ef] then
                    artifactLevelGain = C_ArtifactUI.GetItemLevelIncreaseProvidedByRelic(gemLink)
                    relicType = RelicTypes[RelicSlots[ItemInfo_de3cbe286618f666df102dd52371d2ef][i]]
                end
                gemLv = select(4, GetItemInfo(gemLink))
                if relicType then
                    self:AddDoubleLine(
                        format(" +(%s)|cffffd400[%s]|r%s", artifactLevelGain, gemLv, gemLink),
                        format("|cff00ff00[%s]", relicType),
                        0,
                        1,
                        0,
                        0,
                    ...
                    self:AddLine(format("|cffffd400 [%s] %s|r", gemLv, gemLink))
                end
            end
        end
    end
    if
        (ItemInfo_5b2b9385dc5869461473771f275680cd and ItemInfo_5b2b9385dc5869461473771f275680cd > 0 and
            II_Config.ItemLevel)
     then
        self:AddLine(
            format(
    ...
    if (II_Config.ItemQulity and ItemInfo_0d0e9323a9500f0bec70aa7c547df8b3) then
        local quality = getglobal(format("ITEM_QUALITY%d_DESC", ItemInfo_0d0e9323a9500f0bec70aa7c547df8b3))
        if (quality) then
            self:AppendText(" (" .. quality .. ")")
        end
    end
    ...
    if II_Config.SellValue then
        ...
        if (type(price) == "number" and price > 0) then
            self:AddLine(ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EEEach for sell: |r"])
            ItemInfo_a722f7ebe3a21e277257a47471105b36 = self:NumLines()
            ItemInfo_4ff31b8a539fa2cf7990edc09e693395(self, ItemInfo_a722f7ebe3a21e277257a47471105b36, price, 1)
        end
        local ItemInfo_f3855ba422be79d226acf0ca95a2b15c
        local ItemInfo_ca0de5e9ed087ac8d67ca8d417281946 = self:GetOwner()
        if ItemInfo_ca0de5e9ed087ac8d67ca8d417281946 and ItemInfo_ca0de5e9ed087ac8d67ca8d417281946.count then
            ItemInfo_f3855ba422be79d226acf0ca95a2b15c = ItemInfo_ca0de5e9ed087ac8d67ca8d417281946.count
        end
        if
            (ItemInfo_f3855ba422be79d226acf0ca95a2b15c and type(ItemInfo_f3855ba422be79d226acf0ca95a2b15c) == "number" and
                ItemInfo_f3855ba422be79d226acf0ca95a2b15c > 1) and
                (type(price) == "number" and price > 0)
         then
            self:AddLine(ItemInfo_27564b0f8fc08d6bd0345695785ce4b6["|cff7B68EETotal for sell: |r"])
            ItemInfo_a722f7ebe3a21e277257a47471105b36 = self:NumLines()
            ItemInfo_4ff31b8a539fa2cf7990edc09e693395(
                self,
                ItemInfo_a722f7ebe3a21e277257a47471105b36,
                price * ItemInfo_f3855ba422be79d226acf0ca95a2b15c,
                2
            )
        end
    end
    ...
    if
        (ItemInfo_0397db9e44d4d2fb454377be99924ddb and ItemInfo_0397db9e44d4d2fb454377be99924ddb > 1 and
            II_Config.StackCount)
     then
        self:AddDoubleLine(
            format(
...
function ItemInfo_Toggle(switch)
    if (switch) then
        if (not hasHooked) then
            ...
            BigFoot_HookItemTip(GameTooltip, ItemInfo_e82cbfba30c104197e9c9c6d43949874)
            BigFoot_HookItemTip(ItemRefTooltip, ItemInfo_e82cbfba30c104197e9c9c6d43949874)
            BigFoot_HookItemTip(ShoppingTooltip1, ItemInfo_e82cbfba30c104197e9c9c6d43949874)
            BigFoot_HookItemTip(ShoppingTooltip2, ItemInfo_e82cbfba30c104197e9c9c6d43949874)
...
function ItemInfo_AuctionToggle(switch)
    if (switch) then
        ...
        ItemInfo_bec6b2696ec890fdca8ddd42fbd09040:RegisterEvent("AUCTION_ITEM_LIST_UPDATE")
        ItemInfo_01df612d60ced2cfa8ff3c8d1a39e47d:Enable()
    else
        ItemInfo_f924ef2a8da54a3e2af4e2f83c870fe6 = false
        ItemInfo_bec6b2696ec890fdca8ddd42fbd09040:UnregisterEvent("AUCTION_ITEM_LIST_UPDATE")
