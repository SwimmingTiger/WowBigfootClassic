...
addon.hiddenOptions = {
	...
	["nameplateOtherAtBase"] = { prettyName = "姓名板放在底部", description = "Position other nameplates at the base, rather than overhead. 2=under unit, 0=over unit", type = "boolean" },
	...
	["nameplateMaxDistance"] = { prettyName = "姓名板可见距离", description = "The max distance to show nameplates.", type = "number" },
	...
	["ShowClassColorInFriendlyNameplate"] = { prettyName = "在友方姓名板上标示职业颜色", description = "在友方姓名板上标示职业颜色", type = "boolean" },
