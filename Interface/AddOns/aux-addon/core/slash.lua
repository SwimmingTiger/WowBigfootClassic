...
function SlashCmdList.AUX(command)
    ...
    elseif arguments[1] == 'ignore' and arguments[2] == 'owner' then
        ...
        aux.print('忽略卖家 ' .. status(aux.account_data.ignore_owner))
    elseif arguments[1] == 'action' and arguments[2] == 'shortcuts' then
        ...
        aux.print('快捷ALT ' .. status(aux.account_data.action_shortcuts))
    elseif arguments[1] == 'post' and arguments[2] == 'bid' then
        aux.account_data.post_bid = ({ unit = 'unit', stack = 'stack' })[arguments[3]]
	    aux.print('发布竞拍 ' .. aux.color.blue(aux.account_data.post_bid or 'off'))
    ...
    elseif arguments[1] == 'tooltip' and arguments[2] == 'merchant' and arguments[3] == 'buy' then
        ...
        aux.print('鼠标提示商店购买价 ' .. status(tooltip_settings.merchant_buy))
    elseif arguments[1] == 'tooltip' and arguments[2] == 'merchant' and arguments[3] == 'sell' then
        ...
        aux.print('鼠标提示商店出售价 ' .. status(tooltip_settings.merchant_sell))
    ...
    elseif arguments[1] == 'tooltip' and arguments[2] == 'prospecting' and arguments[3] == 'value' then
        ...
        aux.print('鼠标提示采矿价值 ' .. status(tooltip_settings.prospecting_value))
    elseif arguments[1] == 'tooltip' and arguments[2] == 'prospecting' and arguments[3] == 'distribution' then
        ...
        aux.print('鼠标提示采矿信息 ' .. status(tooltip_settings.prospecting_distribution))
    ...
    elseif arguments[1] == 'clear' and arguments[2] == 'post' then
		...
		aux.print('用法:')
        aux.print('- scale [' .. aux.color.blue(aux.account_data.scale) .. '] - 界面缩放')
        ...
        aux.print('- post bid [' .. aux.color.blue(aux.account_data.post_bid or 'off') .. '] - 发布竞拍')
        ...
        aux.print('- tooltip prospecting value [' .. status(tooltip_settings.prospecting_value) .. '] - 鼠标提示采矿价值')
        aux.print('- tooltip prospecting distribution [' .. status(tooltip_settings.prospecting_distribution) .. '] - 鼠标提示采矿信息')
        aux.print('- tooltip money icons [' .. status(tooltip_settings.money_icons) .. '] - 鼠标提示显示金币图标')
		aux.print('- clear item cache - 清除物品缓存')
        aux.print('- clear post - 清除出售数据')
    end
end
