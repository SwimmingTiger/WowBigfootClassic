...
elseif locale == "zhCN" then
	...
	L.minimapHint = "|cffeda55f点击|r打开BugSack显示最近的错误信息。\n|cffeda55fShift+点击|r重新加载用户界面。\n|cffeda55fRight+点击|r打开BugSack选项。"
	...
	L["altWipeDesc"] = "按住Alt并点击小地图图标来清除已保存的错误。"
	L["Auto popup"] = "自动弹出"
	...
	L["Minimap icon alt-click wipe"] = "Alt+点击小地图图标清除已保存错误"
	...
	L.useMaster = "使用主声道"
	L.useMasterDesc = "在主声道而非默认声道上播放错误音效。"
