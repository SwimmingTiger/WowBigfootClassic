--[[ BigFoot.lua 这里设置的主要是关于变量存储的数据 同时，一些简单的接口开关也设置在这里 同时一个主要的功能是 定义设置界面的接口 包括： BigFoot_SetModVariable BigFoot_GetModVariable BigFoot_ShowKeyBindingFrame 版本：1.15 更新时间：2004年10月24日 更新作者：Andy Xiao ]] if (GetLocale() ==
    "zhCN") then
    BF_RELOADUI_CONFIRM =
        "该操作将会重新载入所有的插件，你确信要这么做吗？"
    ...
    ON_ADDON_LOAD =
        "|cff00efe0插件【|r|c000EEE00%s|r|cff00efe0】载入成功 |r"
...
elseif (GetLocale() == "zhTW") then
    ...
    ON_ADDON_LOAD =
        "|cff00efe0插件【|r|c000EEE00%s|r|cff00efe0】載入成功 |r"
    ...
    BF_ALL_ADDONS_LOADED =
        "|cff00e0e0All Addons loaded, time used:<%2.1f seconds.|r"
...
local function BigFoot_fff18c914a5b3a8d509f2dff0f3fc382()
    ...
    for BigFoot_e914904fab9d05d3f54d52bfc31a0f3f = 1, 4, 1 do
            ...
            function(self)
                ...
                for BigFoot_e914904fab9d05d3f54d52bfc31a0f3f = 9, 1, -1 do
                    if (self.virtual_frames[BigFoot_e914904fab9d05d3f54d52bfc31a0f3f]) then
                        for BigFoot_5e57ab95c762a48d9a126b104db1056f,
                            BigFoot_2e00ffac12aadb3a1fd865993ec505b9 in
                            ipairs(
                                self.virtual_frames[BigFoot_e914904fab9d05d3f54d52bfc31a0f3f]) do
                            BigFoot_2e00ffac12aadb3a1fd865993ec505b9.frame:SetPoint(
                                ...
                                self.virtual_width +
                                    BigFoot_2e00ffac12aadb3a1fd865993ec505b9.x,
                                BigFoot_2e00ffac12aadb3a1fd865993ec505b9.y)
                            self.virtual_width =
                                self.virtual_width +
                                    BigFoot_2e00ffac12aadb3a1fd865993ec505b9.width
                        end
                    end
                end
            end
        BigFoot_9e83872083ad957c8f380801be754171.RegisterAnchorFrame =
            function(self, BigFoot_411b8aa6d5954c6020f0b9c9e80e847a,
                ...
                for BigFoot_e914904fab9d05d3f54d52bfc31a0f3f,
                    BigFoot_2e00ffac12aadb3a1fd865993ec505b9 in
                    ipairs(
                        self.virtual_frames[BigFoot_8e2d4ef9193eed09cc6ce5849fad1f0a]) do
                    if (BigFoot_2e00ffac12aadb3a1fd865993ec505b9.frame ==
                        BigFoot_411b8aa6d5954c6020f0b9c9e80e847a) then
                        BigFoot_2e00ffac12aadb3a1fd865993ec505b9.width =
                            BigFoot_aacf928ffa23e474a000b1b6292d02a9
                        BigFoot_2e00ffac12aadb3a1fd865993ec505b9.point =
                            BigFoot_7dce5c33f0d4836b30c14f18b2fc43f7
                ...
                BigFoot_2e00ffac12aadb3a1fd865993ec505b9.frame =
        ...
        BigFoot_9e83872083ad957c8f380801be754171.UnregisterAnchorFrame =
            function(self, BigFoot_411b8aa6d5954c6020f0b9c9e80e847a)
...
function BigFoot_OnInit(self)
    ...
    if GameMenuButtonHelp then
        GameMenuButtonHelp:SetPoint("TOP", "BigFootMenuButtonOptions", "BOTTOM",
                                    0, -1)
    else
        GameMenuButtonOptions:SetPoint("TOP", "BigFootMenuButtonOptions",
                                       "BOTTOM", 0, -1)
    end
    GameMenuFrame:HookScript("OnShow", function()
        GameMenuFrame:SetHeight(GameMenuFrame:GetHeight() + 25)
    end)
    SlashCmdList["BIGFOOT"] = function() ShowUIPanel(ModManagementFrame) end
...
local function BigFoot_ClearCollector() configCollector = nil end
    ...
    if BFNew_GetNewFrameState and BFNew_GetNewFrameState() then
        ...
        for k, v in pairs(m_table) do
            if v == 1 then
                EnableAddOn(k)
            elseif v == -1 then
                if bigfoot_DisableTab[k] then EnableAddOn(k) end
            end
        end
    else
        if BFNew_GetNewFrameChangeState and BFNew_GetNewFrameChangeState() then
            ...
            for i = 1, GetNumAddOns() do
                ...
                if revision == "BigFoot" then EnableAddOn(i) end
            end
        else
            for k, v in pairs(bigfoot_DisableTab) do EnableAddOn(k) end
        end
        BigFoot_RegistAll()
...
local function BigFoot_38050ee3c376a78c7553c2ca1f2b8f70()
    ...
    BigFoot_Character["VCode"] = BMath:MD5(
                                     BigFoot_Character["Region"] ..
                                         BigFoot_Character["Realm"] ..
                                         BigFoot_Character["Name"] ..
                                         "bf-client")
end
...
local function BigFoot_709b607aba2aaef09caa9948506fcce9()
    ...
    for i = 1, GetNumAddOns() do
        ...
        if reason ~= "DISABLED" and not bLoadOnDemand then LoadAddOn(i) end
    end
end
...
local function BigFoot_5cce98c7af8139064e065c4da9901881(BLoadBefore)
    ...
    while (#m_CallTab > 0) do
        ...
        if InCombatLockdown() then
            ...
            if BLoadBefore then
                if not Bdones then Bdones = true end
                ...
                if UsedTimw > 0.2 or m_LoadAddon > 0.2 then
                    BigFoot_DelayCall(BigFoot_5cce98c7af8139064e065c4da9901881,
                                      0.4)
                    bReSet = true
                    break
                end
...
local function BigFoot_a11c665559fd4fce273df28ca6f92415(BLoadBefore)
    if ISVARIABLESLoaded then
        ...
        BigFoot_DelayCall(BigFoot_a11c665559fd4fce273df28ca6f92415, 1,
                          BLoadBefore)
    end
end
local Bdone
...
function BigFoot_GetModVariable(__mod, BigFoot_be741bd2030ad8ad70d14fb34b673ab8)
    ...
    if (not BigFoot_051cc0cd78a11469a8f78d2062970ca9) then return nil end
    if (not BigFoot_051cc0cd78a11469a8f78d2062970ca9[BigFoot_be741bd2030ad8ad70d14fb34b673ab8]) then
        if (BigFoot_be741bd2030ad8ad70d14fb34b673ab8) then
            BigFoot_051cc0cd78a11469a8f78d2062970ca9[BigFoot_be741bd2030ad8ad70d14fb34b673ab8] =
                ModManagement_GetDefaultValue(__mod,
...
function BigFoot_SetModVariable(__mod, BigFoot_be741bd2030ad8ad70d14fb34b673ab8,
                                BigFoot_2361bab8b48b1041ad740bb561b21aee)
    if (not BigFoot_Config[__mod]) then BigFoot_Config[__mod] = {} end
    BigFoot_Config[__mod][BigFoot_be741bd2030ad8ad70d14fb34b673ab8] =
        BigFoot_2361bab8b48b1041ad740bb561b21aee
end
function BigFoot_FindTableValue(BigFoot_49ccc92cd1bef60d860c1c7f84aaab89,
                                BigFoot_2361bab8b48b1041ad740bb561b21aee)
    for BigFoot_413bf9c15ce77baa8ebf1cda4cbf4887,
        BigFoot_536473f22dedf9f29b94b1004a62b8a0 in
        pairs(BigFoot_49ccc92cd1bef60d860c1c7f84aaab89) do
        if (BigFoot_2361bab8b48b1041ad740bb561b21aee ==
            BigFoot_536473f22dedf9f29b94b1004a62b8a0) then
...
function BigFoot_22055e427df00b6ded4c974381125d87(__mod)
    if (__mod) then
        ...
        for __index, BigFoot_2361bab8b48b1041ad740bb561b21aee in
            pairs(BigFoot_ModOptionConfig[__mod]) do
        ...
        local BigFoot_7c2206e66bf7b5bacd2aa77f76bf4ff2,
              BigFoot_3bb367e1f150a93c099e99df8d49e180
        for BigFoot_7c2206e66bf7b5bacd2aa77f76bf4ff2,
            BigFoot_3bb367e1f150a93c099e99df8d49e180 in
            pairs(BigFoot_ModOptionConfig) do
            ...
            for __index, BigFoot_2361bab8b48b1041ad740bb561b21aee in
                pairs(BigFoot_ModOptionConfig[__mod]) do
                if (BigFoot_2361bab8b48b1041ad740bb561b21aee.variable) then
                    BigFoot_Config[BigFoot_7c2206e66bf7b5bacd2aa77f76bf4ff2][BigFoot_2361bab8b48b1041ad740bb561b21aee.variable] =
                        BigFoot_2361bab8b48b1041ad740bb561b21aee.default
                end
            end
        end
...
function BigFoot_6d1761d16117a98a566f1b4b36cbc7ed()
    ...
    local BigFoot_e914904fab9d05d3f54d52bfc31a0f3f,
          BigFoot_2361bab8b48b1041ad740bb561b21aee
    local m_Tab = {}
    local m_CallTab = {}
    for __mod, BigFoot_3bb367e1f150a93c099e99df8d49e180 in
        pairs(BigFoot_ModOptionConfig) do
        table.insert(m_Tab, BigFoot_3bb367e1f150a93c099e99df8d49e180)
    end
    table.sort(m_Tab, function(left, right)
        if left and right and left[1] and right[1] and left[1].mod and
            right[1].mod then return left[1].mod < right[1].mod end
    end)
    for k, v in pairs(m_Tab) do
        if v and type(v) == "table" then
            for BigFoot_e914904fab9d05d3f54d52bfc31a0f3f,
                BigFoot_2361bab8b48b1041ad740bb561b21aee in ipairs(v) do
                if (BigFoot_2361bab8b48b1041ad740bb561b21aee.init and
                    BigFoot_2361bab8b48b1041ad740bb561b21aee.type ~= "BUTTON") then
                    local tag, message
                    if BigFoot_2361bab8b48b1041ad740bb561b21aee.indent > 0 and
                        BigFoot_2361bab8b48b1041ad740bb561b21aee.parent then
                        table.insert(m_CallTab, {
...
function BigFoot_ShowKeyBindingFrame(BigFoot_7739b813d90aed43ab9d0eb84ec1c1ae)
    ...
    for i, v in pairs(KeyBindingFrame.categoryList.buttons) do
        if (v.element and v.element.category and type(v.element.category) ==
            "table") then
            local currCategory = v.element.category
            for eleNo, eleVal in pairs(currCategory) do
                local BigFoot_d28056e4bcd8f214a25daeabfe052d6e =
                    GetBinding(eleVal)
                if (BigFoot_d28056e4bcd8f214a25daeabfe052d6e ==
                    BigFoot_7739b813d90aed43ab9d0eb84ec1c1ae) then
                    ShowUIPanel(KeyBindingFrame)
                    KeybindingsCategoryListButton_OnClick(v, "LeftButton")
                    KeyBindingFrameScrollFrameScrollBar:SetValue(
                        (eleNo - 1) * KEY_BINDING_HEIGHT)
                end
            end
        end
    end
...
function BigFoot_DisableAllAddons()
    ...
    for i = 1, GetNumAddOns() do
        ...
        bLoadOnDemand = IsAddOnLoadOnDemand(i)
        revision = GetAddOnMetadata(i, "X-Revision")
        if name:lower() ~= "bigfoot" and name:lower() ~= "acp" and name:lower() ~=
            "bigfootbot" and revision == "BigFoot" and reason ~= "DISABLED" and
            not string.find(name, "AtlasLootClassic_") then
...
function BigFoot_786b766d1fd0bf879fd94c1f876cd079(self)
    if (BigFoot_44494375213dfd73e10daddf227fe7fd) then OpenAllBags() end
end
function BigFoot_f044c02de3e35387101ef8bf33fca114(self)
    if (BigFoot_44494375213dfd73e10daddf227fe7fd) then CloseAllBags() end
end
function BigFoot_a9ccdced48307818b972a7083516c3dd(
    ...
    local BigFoot_71ac8c04e9eae3efc1f0b8abcf51fc4c =
        BigFoot_GenCheckSum(BigFoot_e6955c64cf39bdb23dc86de1a9ec2117)
    BigFoot_Error[BigFoot_71ac8c04e9eae3efc1f0b8abcf51fc4c] =
        BigFoot_e6955c64cf39bdb23dc86de1a9ec2117
...
function BigFoot_GenCheckSum(BigFoot_6e4d0db7491d6883f86de390d20dbe5b)
    if (BigFoot_6e4d0db7491d6883f86de390d20dbe5b == nil) then return nil end
    ...
    for __index = 1, __len, 1 do
        if (mod(__index, 2) == 0) then
            BigFoot_05a435746a4fa320ec7c59ba02cf6c6a =
                BigFoot_05a435746a4fa320ec7c59ba02cf6c6a +
                    string.byte(BigFoot_6e4d0db7491d6883f86de390d20dbe5b,
                                __index)
        else
    ...
    return (BigFoot_b38a7bb9216803102fdc3d9f7a3d2e84 *
               BigFoot_05a435746a4fa320ec7c59ba02cf6c6a)
end
...
local function BigFoot_b5d3fbbb39737107d19770a6601568c8()
    ...
    BigFoot_a44ecbf575d7f2eca081a0592e8d84fa.func =
        BigFoot_f5b6f344e3abaf8220ddb46306cf34fc
    BDropDownMenu_AddButton(BigFoot_a44ecbf575d7f2eca081a0592e8d84fa)
    BigFoot_a44ecbf575d7f2eca081a0592e8d84fa = {}
    BigFoot_a44ecbf575d7f2eca081a0592e8d84fa.text = BF_CHANGELOG_TEXT
    BigFoot_a44ecbf575d7f2eca081a0592e8d84fa.func =
        BigFoot_97401a5bc610241b41f9546a71f92484
    BDropDownMenu_AddButton(BigFoot_a44ecbf575d7f2eca081a0592e8d84fa)
end
function BigFootMiniButtonDropDown_OnLoad(self)
    BDropDownMenu_Initialize(self, BigFoot_b5d3fbbb39737107d19770a6601568c8,
                             "MENU")
...
function IsConfigurableAddOn(BigFoot_8983c60d66c8593ec7165ea9dbedb584)
    if (GetAddOnMetadata(BigFoot_8983c60d66c8593ec7165ea9dbedb584, "X-Revision") ~=
        "BigFoot") or
        not BigFoot_472174287cb12dced3487a304239203f[BigFoot_8983c60d66c8593ec7165ea9dbedb584] then
        return false
    end
    local BigFoot_8983c60d66c8593ec7165ea9dbedb584, _, _, _,
          BigFoot_82a3188377d673bfd578b4a1954a3b2c =
        GetAddOnInfo(
            BigFoot_472174287cb12dced3487a304239203f[BigFoot_8983c60d66c8593ec7165ea9dbedb584])
    local originEnabled = GetAddOnEnableState(UnitName("player"),
                                              BigFoot_8983c60d66c8593ec7165ea9dbedb584) >=
                              2
    if BigFoot_82a3188377d673bfd578b4a1954a3b2c == "DISABLED" or
        BigFoot_82a3188377d673bfd578b4a1954a3b2c == "DEP_DISABLED" or
        not originEnabled then return false end
    return true
end
function BigFoot_IsFramePlacedByUser(BigFoot_411b8aa6d5954c6020f0b9c9e80e847a)
    ...
    BigFoot_8d0febf2348ea712b2b375ae95601d5f =
        BigFoot_411b8aa6d5954c6020f0b9c9e80e847a:GetName()
    return
        BigFoot_411b8aa6d5954c6020f0b9c9e80e847a.BigFoot_22682cb060092ed963ec91a4859bd63b
end
...
function BigFoot_LoadAddOn(BigFoot_1652701c940a7445a6e43b954d36ec9b)
    if (not BigFoot_IsAddOnLoaded(BigFoot_1652701c940a7445a6e43b954d36ec9b)) then
        ...
        BigFoot_54712cfd3a2c182c0e5e07016c830ccb[BigFoot_1652701c940a7445a6e43b954d36ec9b] =
            true
    end
...
function BigFoot_IsAddOnLoadedFromBigFoot(
    BigFoot_1652701c940a7445a6e43b954d36ec9b)
...
function BigFoot_HasAddon(name)
    ...
    if BigFoot_472174287cb12dced3487a304239203f[name] then return true end
    return false
end --[[解决新旧界面切换问题 ]]
function BigFoot_AddCollector(func) table.insert(configCollector, func) end
function BigFoot_RegistAll()
    for k, v in pairs(configCollector) do
        bOK, reason = pcall(v)
        if not bOK and BigFoot_Error and BigFoot_Error.debug_Mod and
            G__BIGFOOT_ERRORMESSAGE then G__BIGFOOT_ERRORMESSAGE(reason) end
    end
end
function BigFoot_GetBattlePetData(petOwner, petIndex)
    ...
    local enemyPetType = C_PetBattles.GetPetType(
    ...
    return name, speciesName, level, health, maxHealth, attack, speed,
           enemyPetType, PetType, StyPetType
end
function GetInterfaceInfo() return select(4, GetBuildInfo()) end
function BigFoot_IsClientRunning() return BFClient_Running end
do
    local BigFoot_564cf5717713a1f65b5876c6ee4e8681
    for i = 1, GetNumAddOns() do
        BigFoot_564cf5717713a1f65b5876c6ee4e8681 = GetAddOnInfo(i)
        BigFoot_472174287cb12dced3487a304239203f[BigFoot_564cf5717713a1f65b5876c6ee4e8681] =
            i
    end
end
function IsModelCanWork() return bfModeChangeLoaded end
function GetEntryDisplayID() return BfGetDisplayID("player") end
function GetOriginEntryDisplayID() return BfGetOriginDisplayID("player") end
...
function GetChangeMountDisplayID() return BfGetMountDisplayID("player") end
