...
L["Hide Aura Widget in Headline Mode"] = "不在標題模式中顯示光環組件"
L["Hide Cooldown Spiral"] = "隱藏倒數轉圈動畫"
L["Hides the aura widget when in 'Headline/Text-Only' mode"] = "不在“標題/僅文本”模式中顯示光環組件"
